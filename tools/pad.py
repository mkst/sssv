...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "infile", type=argparse.FileType("rb"), help="file to read from"
    )
    parser.add_argument(
        "outfile", type=argparse.FileType("wb"), help="file to write to"
    )
    parser.add_argument(
        "--alignment", type=int, default=16, help="alignment to pad to, default 16"
    )
    parser.add_argument(
        "--padding", type=int, default=0, help="padding byte, default 0"
    )
