...
typedef struct {
    ...
    /* 0xDE */ u8  padDE[0x2];
    /* 0xE0 */ f32 unkE0;  // used for perspective
...
struct Animal {
    ...
    /* 0x19C */ u8  unk19C; // length of unk1A8 ?
    ...
    /* 0x244 */ u16 unk244;
    /* 0x246 */ u16 unk246;
    /* 0x248 */ Trail *unk248[9]; // tbd, at least 8
    /* 0x26C */ u8  unk26C;
    /* 0x26D */ u8  unk26D;
    /* 0x26E */ u8  pad26E[0x2];
    /* 0x270 */ u8  unk270;
    ...
    /* 0x29C */ WaypointData *unk29C; // WaypointData* ?
    /* 0x2A0 */ u8  unk2A0;
    /* 0x2A1 */ s8  unk2A1;
    /* 0x2A2 */ u8  unk2A2;
    /* 0x2A3 */ u8  pad2A3;
...
struct struct071 {
    ...
    /* 0x4C */  struct {
                    ...
                    s32  pad27 : 1;
                    s32  unk28 : 1; // 1110 1111
                    s32  unk29 : 1; // 1111 0111
                    s32  unk30 : 1; // 1111 1011
                    s32  pad31 : 1;
                } unk4C;
    /* 0x50 */  u8  pad50[0x4];
