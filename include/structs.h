...
typedef struct {
    ...
    s32 unk4;
    s32 unk8;
} struct067_inner1; // size 0xC

typedef struct {
    s16 unk0;
    s16 unk2;
} struct067_inner2; // size 0x4

typedef struct {
    /* 0x0 */  s8 unk0;
    /* 0x1 */  s8 unk1;
    /* 0x2 */  s8 unk2[48];
    /* 0x32 */ u8 unk32[18]; // tbd
    /* 0x44 */ struct059a unk44[2]; // ?
    /* 0x6C */ u8  pad6C[2];
    /* 0x6E */ s8  unk6E[1];
    /* 0x6F */ u8  pad6F[59];
    /* 0xAA */ u16 unkAA[1];
    /* 0xAC */ u8  padAC[120];
    /* 0x124 */ struct067_inner1 unk124[1];
    /* 0x130 */ u8 pad130[708];
    /* 0x3F4 */ struct067_inner2 unk3F4[1];
    /* 0x3F8 */ u8 pad3F8[236];
    /* 0x4E4 */ Gfx *unk4E4[1];
} struct059; // size 0x5d8?
...
typedef struct {
    ...
    /* 0x2 */ u16  unk2[1];
    /* 0x4 */ u8   pad4[0x78];
    /* 0x7C */ struct072_inner1 unk7C[1];
    /* 0x88 */ u8  pad88[708];
    /* 0x34C */ struct072_inner2 unk34C[1];
    /* 0x350 */ u8  pad350[236];
    /* 0x43C */ Gfx *unk43C[1];
    /* 0x440 */ u8 pad440[236];
