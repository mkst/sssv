...
typedef struct {
    /* 0x0 */ s32 score;
    /* 0x4 */ s16 unk4; // if 0 can increase health?
...
typedef struct {
    ...
    /* 0x40D0 */ u8        pad40D0[0x3f0b]; // something * 0x340 ?
    /* 0x7FDB */ u8        unk7FDB;
