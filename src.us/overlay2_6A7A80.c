...
void func_802963D0_6A7A80(FrameContext *arg0) {
    ...
    x = D_803F2D50.waterTileX;
    y = D_803F2D50.waterTileZ;
    width = D_803F2D50.waterTileWidth;
    height = D_803F2D50.waterTileDepth;
...
void func_80296544_6A7BF4(void) {
    ...
    if ((D_803F2D50.waterWaveMode == 1) || (D_803F2D50.waterWaveMode == 2)) {
        temp_f20 = SSSV_PI / 180;
        temp_f22 = 360.0 / 64;
        temp_f24 = 11.612;
        for (i = 0; i < 64; i++) {
...
void func_80296C8C_6A833C(struct063 arg0[73][129]) {
    ...
    Start1 = D_803F2D50.waterTileZ;
    End1 = D_803F2D50.waterTileZ + D_803F2D50.waterTileDepth;

    Start2 = D_803F2D50.waterTileX;
    End2 = D_803F2D50.waterTileX + D_803F2D50.waterTileWidth;
...
void func_8029726C_6A891C(struct063 arg0[73][129]) {
    ...
    sp4C.Start2 = D_803F2D50.waterTileX;
    sp4C.End2 = D_803F2D50.waterTileX + D_803F2D50.waterTileWidth;

    sp4C.Start1 = D_803F2D50.waterTileZ;
    sp4C.End1 = D_803F2D50.waterTileZ + D_803F2D50.waterTileDepth;
...
void func_80297628_6A8CD8(struct063 arg0[73][129], DisplayList *arg1) {
    ...
    if (D_803F2D50.waterTileWidth == 0) {
        return;
    }
    ...
    if ((D_803F2D50.waterTileWidth != 0)) {
        if (D_803F2D50.waterTileDepth != 0) {
            if (gCameraVisibilityMask[0] & 0x20) {
                ...
                sp142 = D_803F2D50.waterTileWidth;
                sp140 = D_803F2D50.waterTileDepth;

                vertsPerRow = sp142 + 1;

                sp164 = D_803F2D50.waterTileX;
                sp160 = D_803F2D50.waterTileZ;
                ...
                for (var_s5 = 0; var_s5 < sp142; var_s5 = (var_s5 + var_t1) - 1) {
                    ...
                    arg1->unk2C2F0[sp136].v.ob[0] = (D_803F2D50.waterTileX << 6);
                    arg1->unk2C2F0[sp136].v.ob[1] = (D_803F2D50.waterTileZ << 6);
                    arg1->unk2C2F0[sp136].v.ob[2] = maxHeight;
                    sp136++;

                    arg1->unk2C2F0[sp136].v.ob[0] = (D_803F2D50.waterTileX << 6);
                    arg1->unk2C2F0[sp136].v.ob[1] = ((D_803F2D50.waterTileZ + D_803F2D50.waterTileDepth) << 6);
                    arg1->unk2C2F0[sp136].v.ob[2] = maxHeight;
                    sp136++;

                    arg1->unk2C2F0[sp136].v.ob[0] = ((D_803F2D50.waterTileX + D_803F2D50.waterTileWidth) << 6);
                    arg1->unk2C2F0[sp136].v.ob[1] = ((D_803F2D50.waterTileZ + D_803F2D50.waterTileDepth) << 6);
                    arg1->unk2C2F0[sp136].v.ob[2] = maxHeight;
                    sp136++;
...
s32 func_80298E08_6AA4B8(s16 arg0, s16 arg1) {
    ...
    if ((arg0 < D_803F2D50.waterTileX) ||
        (arg1 < D_803F2D50.waterTileZ) ||
        ((D_803F2D50.waterTileX + D_803F2D50.waterTileWidth) < arg0) ||
        ((D_803F2D50.waterTileZ + D_803F2D50.waterTileDepth) < arg1)) {
        return 0;
    }
...
void func_80299640_6AACF0(s16 arg0, s16 arg1, s16 *arg2, s16 *arg3, s16 *arg4, s16 *arg5) {
    ...
    if (func_80298E08_6AA4B8(arg0 << 6, arg1 << 6) == 0) {
        ...
        *arg5 += gWaterAnimState.unk0[((arg0 + 1) * (arg1 + 1)) & 7][(u16)(gWaterAnimState.unk204 + ((((arg0 + 1) * (arg1 + 1)) + ((arg0 + 1) * (arg0 + 1))) << 3)) & 63] << 1;
        ...
        c = D_803F2D50.waterTileX;
        a = D_803F2D50.waterTileZ;
        b = D_803F2D50.waterTileWidth + 1;
