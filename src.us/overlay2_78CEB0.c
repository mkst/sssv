...
//
//     if ((D_803D552C->unk320 == 0) && (D_803D552C->unk365 == 0)) {
//         D_803D552C->unk32A = D_803D5544 & 0xffff; // helps but doesnt fix regalloc
//         D_803D552C->unk365 = 11;
//     } else if (D_803D552C->unk320 != 0) {
//         if (func_8033C9CC_74E07C(D_803D5530->xPos, D_803D5530->zPos, (D_803D5530->yPos + (D_803D5524->unkBA >> 1)),
//                 D_803D5530->unk160, D_803D552C->unk320->xPos, D_803D552C->unk320->zPos, D_803D552C->unk320->yPos + (D_803D552C->unk320->unk42 >> 1), 0x7F, 0, 0) == 0) {
//             D_803D552C->unk32A = D_803D5544;
//             if ((D_803D552C->unk320->unk16C->unk0 == 2) || (D_803D552C->unk320->unk16C->unk0 == 0x3D)) {
