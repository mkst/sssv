...
//     }
//
//     if ((((*D_802910D0 & 0x1000) != 0) && (D_802912DE == (u16)1) && (D_803F6680.unk0 == 0)) || (D_803F66A6 == 3)) {
//         if ((D_803E1BC0 == 0) && (D_803C0426 == 0) && (D_8020540C != 1) && (D_803C0422 == 0)) {
//             if ((D_803F2D34 == 0) && (D_803F2E16 == 0) && (D_803F2D38 != 0x23) && ((D_803E4D28 & 0x10) == 0)) {
...
//         D_803C042A = 0;
//     }
//     if (((*D_802910D0 & 0x1000) != 0) && (1 == D_802912DE) && (D_803C0426 == 0) && (D_80204288 == 0xA) && ((D_8023F2A8 & 1) == 0)) {
//         D_803C0426 = 1;
//         D_803C042A = 1;
//     }
//     if (D_803F6680.unk0 != 0) {
//         if (D_803F66AD == 0) {
//             func_80398630_7A9CE0(D_802910D0);
//             D_803F66AD = (u8)1;
//         }
//         func_8038FF68_7A1618();
//     } else {
//         func_8038F414_7A0AC4(D_802910D0);
//         D_80204290 = (u16)2;
//         if (D_803F642C == 0) {
...
//         if (D_802910D0 != 0) {
//             func_802C8FC0_6DA670(D_802910D0);
//         }
...
// //
// //         if ((D_802910D0 != 0) && (D_801D9ED4 == 0) && ((*D_802910D0 & 0x20) != 0)) {
// //             D_801D9ED4 = (u16)0xA;
// //         }
// //         func_8029A624_6ABCD4(&D_801D9E7C);
...
// //
// //         gSPDisplayList(D_801D9E7C++, 0x01003A58);
...
// //         gSPDisplayList(D_801D9E7C++, D_80204278 + sp38); // ?!
// //
...
// //
// //         if (D_803F63C2 != 0) {
// //             func_8037D32C_78E9DC(&D_803B5764, (D_803F63C2 + 1) & 0xFF, 0x19, (gScreenWidth - 0x19) & 0xFFFF, gScreenHeight - 0x64);
// //         }
// //         if (D_803C0422 == 0) {
// //             if (D_803E1BC0 == 0) {
// //                 if (D_803F2D38 != 0x24) {
...
// //         if (D_803C0420 != 0) {
// //             if (D_803C0420 == 1) {
// //                 func_803497DC_75AE8C(D_803C0420, &D_803C0420);
// //                 func_80349720_75ADD0();
// //             }
// //             D_803C0420 = D_803C0420 + 1;
// //             D_803C0420 = D_803C0420 & 0x7F;
// //         }
// //         if (D_803F66A7 != 0) {
// //             func_803800F0_7917A0(D_803F2D71, &D_803C0420);
...
//         }
//     }
//     if ((D_803F2D38 == END_CREDITS) && (D_803F6680.unk0 == 0)) {
//         if (D_803C0428 != 0) {
