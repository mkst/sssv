...
Vtx D_040029D0_102720[32] = {
#include "data/inc/D_040029D0_102720.inc.c"
};
Vtx D_04002BD0_102920[20] = {
#include "data/inc/D_04002BD0_102920.inc.c"
};
Vtx D_04002D10_102A60[8] = {
#include "data/inc/D_04002D10_102A60.inc.c"
};

extern Gfx D_01003548_3CE18[];
extern Gfx D_01003618_3CEE8[];

Gfx D_04002D90_102AE0[] = {
    gsSPDisplayList(D_01003548_3CE18),
    gsDPSetPrimColor(0, 0, 0xFF, 0xFF, 0xFF, 0xFF),
    gsSPVertex(D_040029D0_102720, 32, 0),
    ...
    gsSPVertex(D_04002BD0_102920, 20, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 1, 0, 0),
    ...
    gsSPVertex(D_04002D10_102A60, 8, 0),
...
Vtx D_04002F28_102C78[32] = {
#include "data/inc/D_04002F28_102C78.inc.c"
};
Vtx D_04003128_102E78[20] = {
#include "data/inc/D_04003128_102E78.inc.c"
};
Vtx D_04003268_102FB8[8] = {
#include "data/inc/D_04003268_102FB8.inc.c"
};

Gfx D_040032E8_103038[] = {
    gsSPDisplayList(D_01003548_3CE18),
    gsDPSetPrimColor(0, 0, 0xFF, 0xFF, 0xFF, 0xFF),
    gsSPVertex(D_04002F28_102C78, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 1, 0, 0),
    gsSP2Triangles(2, 4, 0, 0, 4, 2, 5, 0),
    gsSP2Triangles(6, 0, 4, 0, 3, 0, 6, 0),
    gsSP2Triangles(5, 7, 4, 0, 7, 5, 8, 0),
    ...
    gsSP2Triangles(26, 30, 29, 0, 30, 26, 27, 0),
    gsSP2Triangles(27, 31, 30, 0, 31, 27, 28, 0),
    gsSPVertex(D_04003128_102E78, 20, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 1, 0, 0),
    gsSP2Triangles(3, 4, 1, 0, 1, 4, 5, 0),
    gsSP2Triangles(5, 2, 1, 0, 2, 5, 6, 0),
    gsSP2Triangles(6, 7, 2, 0, 7, 6, 8, 0),
    ...
    gsSPDisplayList(D_01003618_3CEE8),
    gsDPSetPrimColor(0, 0, 0x14, 0x14, 0x14, 0xFF),
    gsSPVertex(D_04003268_102FB8, 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSP2Triangles(4, 2, 1, 0, 1, 5, 4, 0),
    gsSP2Triangles(6, 4, 5, 0, 5, 7, 6, 0),
    gsSPEndDisplayList(),
