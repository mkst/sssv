...
Vtx D_040013D0_101120[6] = {
#include "data/inc/D_040013D0_101120.inc.c"
};
Vtx D_04001430_101180[12] = {
#include "data/inc/D_04001430_101180.inc.c"
};

extern Gfx D_01003618_3CEE8[];

Gfx D_040014F0_101240[] = {
    gsDPSetPrimColor(0, 0, 0xFF, 0xFF, 0x80, 0xFF),
    gsSPDisplayList(D_01003618_3CEE8),
    gsSPVertex(D_040013D0_101120, 6, 0),
    gsSP2Triangles(0, 2, 1, 0, 2, 0, 3, 0),
    gsSP2Triangles(4, 3, 0, 0, 1, 5, 4, 0),
    gsSP2Triangles(5, 1, 2, 0, 3, 4, 5, 0),
    gsDPSetPrimColor(0, 0, 0x14, 0x14, 0x14, 0xFF),
    gsSPVertex(D_04001430_101180, 12, 0),
