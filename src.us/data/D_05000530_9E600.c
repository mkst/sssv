...
Vtx D_05000000_9E0D0[8] = {
#include "data/inc/D_05000000_9E0D0.inc.c"
};
Vtx D_05000080_9E150[32] = {
#include "data/inc/D_05000080_9E150.inc.c"
};
Vtx D_05000280_9E350[16] = {
#include "data/inc/D_05000280_9E350.inc.c"
};
Vtx D_05000380_9E450[3] = {
#include "data/inc/D_05000380_9E450.inc.c"
};
Vtx D_050003B0_9E480[24] = {
#include "data/inc/D_050003B0_9E480.inc.c"
};

const Gfx D_05000530_9E600[] = {
    gsSPClearGeometryMode(G_LIGHTING),
    gsSPVertex(D_05000000_9E0D0, 8, 0),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPCullDisplayList(0, 8),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 0xFF, 0xFF, 0xFF, 0xFF),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPVertex(D_05000080_9E150, 32, 0),
    ...
    gsSPVertex(D_05000280_9E350, 16, 0),
    ...
    gsSPVertex(D_05000380_9E450, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 0xFF, 0xFF, 0xFF, 0xFF),
    gsSPSetGeometryMode(G_CULL_BACK),
    gsSPVertex(D_050003B0_9E480, 24, 0),
