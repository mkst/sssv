...
Vtx D_04001590_1012E0[4] = {
#include "data/inc/D_04001590_1012E0.inc.c"
};
Vtx D_040015D0_101320[14] = {
#include "data/inc/D_040015D0_101320.inc.c"
};
Vtx D_040016B0_101400[14] = {
#include "data/inc/D_040016B0_101400.inc.c"
};
Vtx D_04001790_1014E0[4] = {
#include "data/inc/D_04001790_1014E0.inc.c"
};
Vtx D_040017D0_101520[14] = {
#include "data/inc/D_040017D0_101520.inc.c"
};

extern Gfx D_010034C0_3CD90[];
extern Gfx D_01003548_3CE18[];

Gfx D_040018B0_101600[] = {
    gsSPDisplayList(D_010034C0_3CD90),
    gsSPTexture(0xC000, 0x8000, 0, 1, G_ON),
    gsSPVertex(D_04001790_1014E0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSPVertex(D_040016B0_101400, 14, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    ...
    gsSPVertex(D_04001590_1012E0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSPVertex(D_040017D0_101520, 14, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSP2Triangles(4, 0, 3, 0, 3, 5, 4, 0),
    ...
    gsSPVertex(D_040015D0_101320, 14, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
