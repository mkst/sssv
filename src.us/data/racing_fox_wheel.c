...
Vtx D_04004390_CBDC0[16] = {
#include "data/inc/D_04004390_CBDC0.inc.c"
};
Vtx D_04004490_CBEC0[16] = {
#include "data/inc/D_04004490_CBEC0.inc.c"
};
extern Gfx D_01003548_3CE18[];

Gfx racing_fox_wheel[] = {
    ...
    gsSPVertex(D_04004490_CBEC0, 16, 0),
