...
void func_8036F7A0_780E50(void) {
    ...
    sp9E = func_802E89F0_6FA0A0(D_803D552C->xPos.w, D_803D552C->zPos.w, D_803D552C->yPos.w + (D_803D5524->unkBA << 0xF), 0x2080, (u8) 8, (s16) 0x64, (s16) 0x50, (s16) 0, (s8) 1, var_v0 == 0);

done:
    if (sp9E == 0) {
        func_8038C98C_79E03C();
        temp_t7 = (D_803D5544 - D_803D552C->unk35E); // & 0xFFFF;
        if (((temp_t7 & 0xFF) < 0x50) && (temp_t7 >= 0x100) && ((D_803D552C->unk366 == 1) || (D_803D552C->unk366 == 3))) {
            if ((func_8012826C() & 0x1F00) == 0x1900) {
                D_803D5530->yRotation = (s16) ((s32) ((SSSV_RAND(64) + D_803D5530->yRotation) - 0x20) % 360);
            }
        ...
        D_803F2EBC = ((s32) (D_803F2EBC - FTOFIX32(1.0)) >> 2) + FTOFIX32(1.0);
        D_803F2EC0 = ((s32) (D_803F2EC0 - FTOFIX32(1.0)) >> 2) + FTOFIX32(1.0);
        D_803F2EC4 = ((s32) (D_803F2EC4 - FTOFIX32(1.0)) >> 2) + FTOFIX32(1.0);
        ...
        if ((D_803F2ECE == 0) || (D_803F2ECC < 0x1F)) {
                ...
                if ((D_803D5544 - D_803D552C->unk32A) == 3) {
                    if (func_803224C4_733B74(0x2D, 0x2D, -0xB, 0x16, 0xC, 0, 0, 0x12) != 0) {
                        if ((D_803D5538 == 0) && (D_803F2DA2 == 3)) {
                            play_sound_effect_at_location(SFX_UNKNOWN_26, 0x5000, 0, D_803D5530->xPos.h, D_803D5530->zPos.h, D_803D5530->yPos.h, 0.75f);
                        } else {
                            play_sound_effect_at_location(SFX_UNKNOWN_26, 0x5000, 0, D_803D5530->xPos.h, D_803D5530->zPos.h, D_803D5530->yPos.h, 1.0f);
                        }
                    } else {
                        play_sound_effect_at_location(SFX_UNKNOWN_14, 0x5000, 0, D_803D5530->xPos.h, D_803D5530->zPos.h, D_803D5530->yPos.h, 1.0f);
                    }
                }
                break;
            ...
            func_8038CCF0_79E3A0(0x65, 3, 7, 0x13, (s16) 0x14, (s16) -1);
            func_8038CCF0_79E3A0(-0x66, 4, 0xA, -1, (s16) -1, (s16) -1);
            ...
            D_80203FE0[20].unk0 = tmp1 + (((temp_t1 * temp_a3) >> 8) + ((temp_a1 * temp_t2) >> 8));
            D_80203FE0[20].unk2 = tmp2 + (((temp_a3 * temp_t2) >> 8) - ((temp_t1 * temp_a1) >> 8));

            temp_a0 = D_803D552C->unk365;
            if (temp_a0 == 4) {
...
#pragma _permuter sameline end
                ...
                func_802C78B0_6D8F60(0x13, 0x14, (D_803F2EC8 * 0x34) >> 6, (D_803F2EC8 * 0x34) >> 6, (D_803F2EC8 * 0x34) >> 6, D_803F2ED0, 0, 0, 0, &D_04004010);
            }
    ...
    if ((sp9E == 0) || (sp9E == 2)) {
        func_8034BD20_75D3D0(D_803D552C->xPos.h, D_803D552C->zPos.h, D_803D552C->yPos.h + (D_803D5524->unkBA >> 1), D_803D552C->unk302, &D_01033190, (s16) 0x1F, (s16) 0x1F, (s16) 0x9B, 0, 0, 0, (s16) 0, (s16) (s32) D_803D5538);
    }
    ...
    if (spAE != 0) {
        if ((sp9E == 0) && (D_803F2EDB != 0)) {
            func_802DE914_6EFFC4(
                spAE,
                D_803D5530->xPos.w + ((D_80203FE0[26].unk2 * D_80152C78[D_803D552C->unk302 & 0xFF]) / 16),
                D_803D5530->zPos.w + ((D_80203FE0[26].unk2 * D_80152C78[(s16)(D_803D552C->unk302 + 0x40) & 0xFF]) / 16),
...
void func_80370C84_782334(void) {
    ...
    spDE = func_802E89F0_6FA0A0(D_803D552C->xPos.w, D_803D552C->zPos.w, D_803D552C->yPos.w + (D_803D5524->unkBA << 0xF), 0x820, (u8) 8, (s16) 0x64, (s16) 0x51, (s16) 0, (s8) 1, (u8) (var_v0_2 == 0));
done:
    if (spDE == 0) {
        func_8038C98C_79E03C();
        ...
        if ((D_803F2ECE == 0) || ((s32) D_803F2ECC < 0x1F)) {
            ...
            func_802C1A44_6D30F4(0x3CF, 0, (s32) &spE8);
            func_802C4A70_6D6120(0x1E7, 0x28A, 6);
            func_80320DF8_7324A8(0x1E7, 0x32C);
            func_802BB840_6CCEF0(0x196);

            temp_v0_3 = D_80203FE0[20].unk0 - D_80203FE0[19].unk0;
            D_80203FE0[26].unk4 = (s16) (D_80203FE0[26].unk4 + 0x16D);
            temp_a0 = D_80203FE0[20].unk2 - D_80203FE0[19].unk2;
            temp_a3 = D_80152350.unk2D0[D_803D552C->unk316];
            temp_t0_2 = D_80152350.unk384[D_803D552C->unk316];
            D_80203FE0[20].unk0 = D_80203FE0[19].unk0 + (((temp_a3 * temp_a0) >> 8) + ((temp_v0_3 * temp_t0_2) >> 8));
            D_80203FE0[20].unk2 = D_80203FE0[19].unk2 + (((temp_a0 * temp_t0_2) >> 8) - ((temp_a3 * temp_v0_3) >> 8));
        }
        ...
        case ATTACK_KANGAROO_5:
            temp_t6 = (D_803D5544 - D_803D552C->unk32A); // & 0xFFFF;
            if (temp_t6 < 8) {
                D_80203FE0[7].unk4 += (temp_t6 * 0x32C) >> 3;
                D_80203FE0[7].unk2 -= (temp_t6 * 0x32C) >> 3;
            } else {
        ...
        case ATTACK_KANGAROO_3:
            temp_t6 = (D_803D5544 - D_803D552C->unk32A);// & 0xFFFF;
            if ((temp_t6 < 0x26) && ((D_803D5530->unk4A == 0))) {
                sp68 = temp_t6;
                func_8032CD70_73E420(D_803D5530, 0x1F, 0x5000, 0, (((D_80152C78[(s16)(temp_t6 * 8) & 0xFF] >> 7) / 400.0) + 1.0), (s16) (s32) D_803D5530->xPos.h, (s16) (s32) D_803D5530->zPos.h, (s16) (s32) D_803D5530->yPos.h);
                if ((D_80204278->usedModelViewMtxs + 6) < 0xFA) {
                    ...
                    for (spD8 = 0; spD8 < 6; spD8++) {
                        ...
                        if ((temp_t1 >= 0) && (temp_t1 < 0x20)) {
                            temp_v0_5 = D_803D552C->unk32C;
                            temp_t0_3 = temp_v0_5 - (temp_t1 * 8);
                            var_s1 = (s32) ((((s16) D_80152C78[temp_v0_5 & 0xFF] >> 7) - ((s16) D_80152C78[temp_t0_3 & 0xFF] >> 7)) * 0x15) >> 5;
                            var_s2 = (s32) ((((s16) D_80152C78[(temp_v0_5 + 0x40) & 0xFF] >> 7) - ((s16) D_80152C78[(temp_t0_3 + 0x40) & 0xFF] >> 7)) * 0x15) >> 5;
                            func_80127640(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs], D_803D5530->xPos.w + (var_s1 << 0x10), D_803D5530->zPos.w + (var_s2 << 0x10), D_803D5530->yPos.w + (D_803D5524->unkBA * 0xC000), (s16) ((temp_t1 * 0x10) & 0xFF), 0x4000, 0x4000, 0x4000, (s16) 0, 0);
                            gSPMatrix(D_801D9E88++, OS_K0_TO_PHYSICAL(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs++]), G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
                    ...
                    spBF = 0;
                    if (func_80322A58_734108((s16) (D_803D5530->xPos.h + var_s1), (s16) (D_803D5530->zPos.h + var_s2), (s16) (D_803D5530->yPos.h + ((s32) (D_803D5524->unkBA * 3) >> 2)), 0x14, (s16) 0x1E, &spC0, NULL, (u8) 8) != 0) {
                        spBF = 1;
                        play_sound_effect_at_location(0x61, 0x7FFF, 0, D_803D5530->xPos.h, (s16) (s32) D_803D5530->zPos.h, (s16) (s32) D_803D5530->yPos.h, 1.0f);
                    }
                    temp_v1_7 = D_803D5524->unkBA;
                    temp_a0_2 = D_803D5530->xPos.h;
                    temp_a1_2 = D_803D5530->zPos.h;
                    temp_t0_4 = D_803D5530->yPos.h;

                    tmp1 = func_8033C9CC_74E07C(
                        temp_a0_2,
                        temp_a1_2,
                        temp_t0_4 + ((s32) temp_v1_7 >> 1),
                        D_803D5530->unk160,
                        temp_a0_2 + var_s1,
                        temp_a1_2 + var_s2,
                        temp_t0_4 + ((s32) (temp_v1_7 * 3) >> 2),
                        func_803136FC_724DAC((D_803D5530->xPos.h + var_s1), D_803D5530->zPos.h + var_s2, (D_803D5530->yPos.h + ((s32) (D_803D5524->unkBA * 3) >> 2))),
                        0,
                        0);

                    if ((tmp1 != 0) || ((((D_803D5530->yPos.h + ((s32) (D_803D5524->unkBA * 3) >> 2)) < (func_8031124C_7228FC((s16) (D_803D5530->xPos.h + var_s1), (s16) (D_803D5530->zPos.h + var_s2)) >> 0x10)) != 0))) {
                        spBF = 1;
                        play_sound_effect_at_location(0x26, 0x5000, 0, D_803D5530->xPos.h, (s16) (s32) D_803D5530->zPos.h, (s16) (s32) D_803D5530->yPos.h, 1.0f);
                    }
                    if (spBF != 0) {
                        D_803D552C->unk365 = ATTACK_KANGAROO_4;
                        D_803D552C->unk32A = D_803D5544;
                        D_803D552C->unk32C = ((var_s1 << 6) & 0xFF00) | ((var_s2 >> 2) & 0xFF);

                        for (spDC = 0; spDC < 4; spDC++) {
                            create_particle_effect(
                                D_803D5530->xPos.h + var_s1,
                                D_803D5530->zPos.h + var_s2,
                                D_803D5530->yPos.h + ((s32) (D_803D5524->unkBA * 3) >> 2),
                                0x18,
                                (SSSV_RAND(16) - 7) << 0x10,
                                (SSSV_RAND(16) - 7) << 0x10,
                                SSSV_RAND(16) << 0x10,
        ...
        case 34:
            ...
            if (temp_t6 < 0x10) {
                sp68 = temp_t6;
                func_8013328C(D_803D5530, 0x1F, 0x40, ((((s16) D_80152C78[(-temp_t6 * 8) & 0xFF] >> 7) / 400.0) + 1.0), (s16) 0x5000, (s16) 0);
                // sp68 = temp_t6;
                if ((D_80204278->usedModelViewMtxs + 6) < 0xFA) {
                    for(spD8 = 0; spD8 < 6; spD8++) {
                        temp_t3 = (sp68 + spD8) - 3;
                        if ((temp_t3 >= 0) && (temp_t3 < 0x10)) {
                            ...
                            temp_t0_5 = ((s16) D_80152C78[(temp_t1_2 + 0x40) & 0xFF] >> 7) + 0x100;
                            func_80127640(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs], D_803D5530->xPos.w + (((s32) (temp_t0_5 * ((s16) (temp_t8_2 & 0xFF00) >> 6)) >> 9) << 0x10), D_803D5530->zPos.w + (((s32) (temp_t0_5 * ((s16) (temp_t8_2 << 8) >> 6)) >> 9) << 0x10), D_803D5530->yPos.w + (D_803D5524->unkBA * 0xC000), (s16) (temp_t1_2 & 0xFF), 0x4000, 0x4000, 0x4000, (s16) 0, 0);
                            gSPMatrix(D_801D9E88++, OS_K0_TO_PHYSICAL(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs++]), G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
        ...
        if (((D_80204278->usedModelViewMtxs + 0x1E) < 0xFA) && (D_803F2EDA != 0) && ((temp_a1_3 = D_803D5538, (temp_a1_3 != 0)) || (temp_v0_15 = D_803F2AA2, (temp_v0_15 == 0)) || (temp_v0_15 == 2) || ((temp_v0_15 == 1) && ((s32) D_803F2AA3 >= 0xB))) && ((D_803F2C18[0] != 0) || (temp_a1_3 == 0) || (((D_803F28E0[D_803F2A98].cameraMode != 3)) && (D_803F28E0[D_803F2A98].cameraMode != 0x11)) || (D_803F28E0[D_803F2A98].unk64 != -3))) {
            func_80127640(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs], D_803D5530->xPos.w, D_803D5530->zPos.w, D_803D5530->yPos.w, (s16) (s32) -D_803D552C->unk302, (s32) D_803F2EB0 / 4, (s32) D_803F2EB4 / 4, (s32) D_803F2EB8 / 4, (s16) (s32) D_803F2ED2, D_803F2ED4);
            gSPMatrix(D_801D9E88++, OS_K0_TO_PHYSICAL(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs++]), G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);

            func_8038C230_79D8E0((D_803D5524->unkBA * 8) / 5, 2, 3, 3, -0.4f);
            func_8038C484_79DB34(2, 1, 3, -0.18f, (s16) 0);
            if ((D_803D552C->unk366 != 5) && (D_803D552C->unk366 != 2) && (D_803F2D10.unk0 == 0)) {
                ...
                func_80300130_7117E0(&spE6, &D_803D552C->unk30A, 0x60, -0x100, (s16) 3, (s16) 3, (s16) (D_803D5530->yVelocity.h * 0x10), (s16) 4);
            } else {
                spE6 = D_803D552C->unk308;
            }
            D_803D552C->unk308 = spE6;
            func_802C78B0_6D8F60(2, 0xE, 0xD000, 0xD000, 0xD000, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_04003C60_EB210);

            var_v1_2 = spE6 << 7;
            if (var_v1_2 > 0x1F40) {
                var_v1_2 = ((s32) (var_v1_2 - 0x1F40) >> 1) + 0x1F40;
            }
            if (var_v1_2 < -0x1F40) {
                var_v1_2 = ((s32) (var_v1_2 + 0x1F40) >> 1) - 0x1F40;
            }
            temp_v0_20 = var_v1_2 / 32;
            temp_t9_2 = var_v1_2 >> 1;
            D_80203FE0[2].unk4 += temp_v0_20;
            D_80203FE0[1].unk4 += temp_v0_20;
            ...
            func_802C78B0_6D8F60(0x13, 0x14, 0xD000, 0xD000, 0xD000, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_04002E30_EA3E0);
            if (D_803F2EDD == 0) { func_802C78B0_6D8F60(3, 7, 0xD000, 0xD000, 0xD000, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_04003470_EAA20); }

            gSPClearGeometryMode(D_801D9E88++, G_CULL_BACK);
            gSPSetGeometryMode(D_801D9E88++, G_CULL_FRONT);
            if (D_803F2EDD == 0) { func_802C78B0_6D8F60(4, 0xA, 0xD000, 0xD000, 0xD000, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 1, (u8) 0, &D_04003470_EAA20); }
            if ((D_803D552C->unk365 != ATTACK_KANGAROO_4) && (D_803D552C->unk365 != ATTACK_KANGAROO_3)) {
                ...
                func_802C78B0_6D8F60(3, 7, 0xD000, 0xD000, 0xD000, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_04003F40_EB4F0);
            }
            if (D_803F2EDD == 0) {
                func_8031A150_72B800(D_803D552C->unk326++, &spE2, &spE0);
                func_8031A278_72B928(&D_803D552C->unk326, (s16 *) &spE2, (s16 *) &spE0);
                spE2 = D_803BD5B2_7CEC62[spE2]; spE0 = D_803BD66A_7CED1A[spE0];
                func_80356BD8_768288(&D_01000CA0, &D_01002100, spE2);
                func_802C78B0_6D8F60(0x13, 0x14, (D_803F2EC8 * 0x34) >> 6, (D_803F2EC8 * 0x34) >> 6, (D_803F2EC8 * 0x34) >> 6, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_04003FF0_EB5A0);
                func_80356BD8_768288(&D_01000CA0, &D_01002100, (s16) spE0);
                func_802C78B0_6D8F60(0x13, 0x14, (D_803F2EC8 * 0x34) >> 6, (D_803F2EC8 * 0x34) >> 6, (D_803F2EC8 * 0x34) >> 6, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_04004010);
            }
    ...
    if ((spDE == 0) || (spDE == 2)) {
        func_8034BD20_75D3D0(D_803D552C->xPos.h, D_803D552C->zPos.h, (s16) (D_803D552C->yPos.h + ((s32) D_803D5524->unkBA >> 1)), D_803D552C->unk302, &D_01033190, (s16) 0x15, (s16) 0x15, (s16) 0x9B, 0, 0, 0, (s16) 0, (s16) (s32) D_803D5538);
    }
    temp_a0_5 = D_803D5528->unk3C8.unk2;
    if (temp_a0_5 != 0) {
        if ((spDE == 0) && (D_803F2EDB != 0)) {
            temp_v1_15 = D_80203FE0[26].unk2; // unkD2;
            temp_v0_28 = D_803D552C->unk302;
            func_802DE914_6EFFC4(
                temp_a0_5,
                ((temp_v1_15 * (D_80152C78[((temp_v0_28 & 0xFF))])) / 16) + D_803D5530->xPos.w,
                ((temp_v1_15 * (D_80152C78[(((temp_v0_28 + 0x40) & 0xFF))])) / 16) + D_803D5530->zPos.w,
                ((D_80203FE0[26].unk4 << 0x10) / 32) + D_803D5530->yPos.w,
                (s16) (s32) temp_v0_28);
            if (D_803E00C0[D_803D5528->unk3C8.unk2].unk34 == 1) {
                if (D_803E00C0[D_803D5528->unk3C8.unk2].unk2E == 3) {
                    func_802DD244_6EE8F4(D_803D5528->unk3C8.unk2, (s16 *) &D_803A3B4C_7B51FC);
                } else {
                    func_802DD244_6EE8F4(D_803D5528->unk3C8.unk2, (s16 *) &D_803A3BAC_7B525C);
                }
            }
            D_803E00C0[D_803D5528->unk3C8.unk2].unk34 = 0;
        } else {
    ...
    if (spDE == 0) {
        func_80303820_714ED0(D_803D552C, 1, 2, 0x391, (u16) 1);
        func_80303820_714ED0(D_803D552C, 1, 0x13, 0x28A, (u16) 0);
        func_80303D50_715400(D_803D552C, 2);
    } else {
