...
void func_803766E8_787D98(void) {
    ...
    if (D_803D5530->state < 26) {
        ...
        phi_v1 = MAX(MAX(D_803C0740[(D_803D5530->xPos >> 6) + 0][(D_803D5530->zPos >> 6) + 0].unk6,
                         D_803C0740[(D_803D5530->xPos >> 6) + 1][(D_803D5530->zPos >> 6) + 0].unk6),
                     MAX(D_803C0740[(D_803D5530->xPos >> 6) + 0][(D_803D5530->zPos >> 6) + 1].unk6,
                         D_803C0740[(D_803D5530->xPos >> 6) + 1][(D_803D5530->zPos >> 6) + 1].unk6));

        tmp = D_803C0430.unk0[(D_803D5530->xPos * D_803D5530->zPos) & 7][(u16)(D_803C0430.unk204 + (((D_803D5530->xPos * D_803D5530->zPos) + (D_803D5530->xPos * D_803D5530->xPos)) << 3)) & 63] + (4 * phi_v1);
        phi_v1 = ABS(tmp - D_803D5530->yPos);
        if (phi_v1 < 48) {
...
void func_803769E0_788090(void) {
    ...
    fire_homing_missile(D_803D5530->xPos + ((((D_80152C78[(u8)(D_803D552C->unk302 + 64)] >> 7) * tmp) / 32) >> 8),
