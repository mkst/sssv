...
void func_80302200_7138B0(void) {
    ...
    if (sp70 == 0) {
        ...
        if (((D_80204278->usedModelViewMtxs + 30) < 250) &&
            ...
            load_1_tile(D_04008C10_108960, D_04008A10_108760);
            func_802C78B0_6D8F60(1, 2, ((0x10000 - (sp72 << 5)) * 0x2E) >> 6, ((0x10000 - (sp72 << 5)) * 0x2E) >> 6, ((0x10000 + (sp72 << 6)) * 0x2E) >> 6, D_803F2ED0, 0, 0, 0, D_04008290_107FE0);
