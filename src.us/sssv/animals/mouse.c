...
extern s16 D_803A5D20_7B73D0[];
extern s16 D_803A5D2C_7B73DC[];
extern u8  D_803A5D38_7B73E8[];
extern u8  D_803A5D48_7B73F8[];
extern u8  D_803A5D70_7B7420[];
extern s16 D_803A5E84_7B7534[];
...
void func_8031C7A0_72DE50(void) {
    ...
    if (D_803D5524->unk9C == MOUSE2) {
        func_8037E6DC_78FD8C(D_803D5530->xPos.h, D_803D5530->zPos.h, D_803D5530->yPos.h, 0x1C0, 0xA);
    }
    if (D_803D5538 != 0) {
    ...
    sp86 = func_802E89F0_6FA0A0(D_803D552C->xPos.w, D_803D552C->zPos.w, D_803D552C->yPos.w + (D_803D5524->unkBA << 0xF), 0x640, (u8) 7, (s16) 0x3F, (s16) 0x51, (s16) 0x9E, (s8) 1, var_v1 == 0);
    ...
    if (sp86 == 0) {
        if (D_803D552C->unk30A != 0) {
            ...
            if (((D_803D552C->unk366 == 2) || (D_803D552C->unk366 == 5)) && SSSV_RAND(64) == 0) {
        ...
        if (D_803D552C->unk312 != 0) {
            ...
            if (((D_803D552C->unk366 == 2) || (D_803D552C->unk366 == 5)) && SSSV_RAND(16129) == 0) {
        ...
        if ((D_803D552C->unk366 == 5) || ((D_803D5538 != 0) && (D_803F2D30.unk4 >= 0x11))) {
        ...
        if (((D_80204278->usedModelViewMtxs + 30) < 250) &&
            ...
            func_802C78B0_6D8F60(1U, 2U, (D_803F2EBC * 0xA) >> 6, (D_803F2EC0 * 0xA) >> 6, (D_803F2EC4 * 0xA) >> 6, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_040056C0_CD0F0);
            ...
            func_802C78B0_6D8F60(1U, 0x14U, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_04005A50_CD480);
            if (D_803D5524->unk9C == MOUSE) {
                func_802C78B0_6D8F60(0x13U, 0x16U, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (s16) (s32) D_803F2ED0, D_803A5E84_7B7534[D_803D552C->unk30A], (u8) 0, (u8) 0, &D_040053D0_CCE00);
                func_802C78B0_6D8F60(0x13U, 0x17U, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (s16) (s32) D_803F2ED0, D_803A5E84_7B7534[D_803D552C->unk312], (u8) 1, (u8) 0, &D_040053D0_CCE00);
            }
            gSPClearGeometryMode(D_801D9E88++, G_CULL_BACK);
            gSPSetGeometryMode(D_801D9E88++, G_CULL_FRONT);

            if (D_803F2EDD == 0) {
                func_8031A150_72B800(D_803D552C->unk326++, (u16 *) &sp8A, (u16 *) &sp88);
                func_8031A278_72B928(&D_803D552C->unk326, &sp8A, &sp88);
                sp8A = D_803BD5B2_7CEC62[sp8A];sp88 = D_803BD66A_7CED1A[sp88];
                func_80356BD8_768288(&D_01000CA0, &D_01002100, sp8A);
                func_802C78B0_6D8F60(1U, 0x14U, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_04006B00_CE530);
                func_80356BD8_768288(&D_01000CA0, &D_01002100, sp88);
                func_802C78B0_6D8F60(1U, 0x14U, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (s16) (s32) D_803F2ED0, (s16) 0, (u8) 0, (u8) 0, &D_04006B60_CE590);
    ...
    if ((sp86 == 0) || (sp86 == 2)) {
        func_8034BD20_75D3D0(D_803D552C->xPos.h, D_803D552C->zPos.h, (s16) (D_803D552C->yPos.h + ((s32) (D_803D5524->unkBA * 7) >> 3)), D_803D552C->unk302, &D_01033190, (s16) 7, (s16) 7, (s16) 0x9B, 0, 0, 0, (s16) 0, (s16) (s32) D_803D5538);
    }
...
void func_8031D624_72ECD4(void) {
    ...
    if (sp92 == 0) {
        ...
        if (((D_80204278->usedModelViewMtxs + 30) < 250) &&
            ...
            func_802C78B0_6D8F60(1, 20, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (s32) D_803F2ED0, 0, 0, 0, D_04005A50_CD480);
...
#pragma _permuter sameline end
    ...
    if ((sp92 == 0) || (sp92 == 2)) {
        func_8034BD20_75D3D0(
            D_803D552C->xPos.h,
            D_803D552C->zPos.h,
            D_803D552C->yPos.h + ((D_803D5524->unkBA * 7) >> 3),
            D_803D552C->unk302,
            D_01033190,
            7,
            7,
    ...
    if (spAE != 0) {
        if ((sp92 == 0) && (D_803F2EDB != 0)) {
            ...
            temp_t1 = D_80152C78[D_803D552C->unk302 & 0xFF];
#pragma _permuter sameline start
            temp_t2 = D_80152C78[(D_803D552C->unk302 + 0x40) & 0xFF];temp_t3 = D_80203FE0[26].unk0;
#pragma _permuter sameline end
            temp_t4 = (((temp_t0 * temp_t1) / 32) + D_803D5530->xPos.w) + ((temp_t2 * temp_t3) / 32);
            temp_t5 = (D_803D5530->zPos.w + ((temp_t2 * temp_t0) / 32)) - ((temp_t3 * temp_t1) / 32);
...
void func_8031E6A0_72FD50(void) {
    ...
    if (spA6 == 0) {
        ...
        if (((D_80204278->usedModelViewMtxs + 30) < 250) &&
            ...
            func_8038C230_79D8E0((D_803D5524->unkBA * 8) / 5, 2, 3, 3, -0.32f); // D_803BD9D4_7CF084
            func_802C78B0_6D8F60(2, 1, (D_803F2EBC * 0xA) >> 6, (D_803F2EC0 * 0xA) >> 6, (D_803F2EC4 * 0xA) >> 6, D_803F2ED0, 0, 0, 0, D_04006040_CDA70);
            D_80203FE0[1].unk2  += 0x3E;
            D_80203FE0[19].unk2 += 0x3E;
            D_80203FE0[20].unk2 += 0x3E;
            ...
            if (D_803F2EDD == 0) {
                spAE = D_803BD5B6_7CEC66[0]; spAC = D_803BD66E_7CED1E[0];
    ...
    if (spC6 != 0) {
        if ((spA6 == 0) && (D_803F2EDB != 0)) {
            ...
            temp_t3 = -D_80203FE0[26].unk0;
            // hack for [multu   t0,t2]  swap
            temp_t4 = (((temp_t0 * (0, temp_t2)) / 32) + D_803D5530->xPos.w) + ((temp_t1 * temp_t3) / 32);
            temp_t5 = (D_803D5530->zPos.w + ((temp_t1 * temp_t2) / 32)) - ((temp_t3 * temp_t0) / 32);
            temp_t6 = D_803D5530->yPos.w + ((D_80203FE0[26].unk4 << 0x10) / 32);
            func_802DE914_6EFFC4(
                spC6,
                temp_t4,
