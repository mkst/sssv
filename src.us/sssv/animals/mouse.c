...
void func_8031C7A0_72DE50(void) {
    ...
    if (D_803D5524->animalType == MOUSE2) {
    ...
    sp86 = classify_object_visibility(D_803D552C->position.xPos.w, D_803D552C->position.zPos.w, D_803D552C->position.yPos.w + (D_803D5524->height << 0xF), 0x640, (u8) 7, (s16) 0x3F, (s16) 0x51, (s16) 0x9E, (s8) 1, var_v1 == 0);
    ...
    if (sp86 == 0) {
        if (D_803D552C->unk30A != 0) {
            ...
            if (((D_803D552C->movementMode == MOVEMENT_MODE_2) || (D_803D552C->movementMode == MOVEMENT_MODE_DEACTIVATED)) && SSSV_RAND(64) == 0) {
        ...
        if (D_803D552C->unk312 != 0) {
            ...
            if (((D_803D552C->movementMode == MOVEMENT_MODE_2) || (D_803D552C->movementMode == MOVEMENT_MODE_DEACTIVATED)) && SSSV_RAND(16129) == 0) {
        ...
        if ((D_803D552C->movementMode == MOVEMENT_MODE_DEACTIVATED) || ((D_803D5538 != 0) && (gGameState.unk4 >= 0x11))) {
            if (D_803D5528->unk3C8.unk2 != 0) {
                D_803E00C0[D_803D5528->unk3C8.unk2].tailType = TAIL_TYPE_MOUSE_DEAD;
            }
        } else {
            if (D_803D5528->unk3C8.unk2 != 0) {
                D_803E00C0[D_803D5528->unk3C8.unk2].tailType = TAIL_TYPE_MOUSE;
            }
        }
        ...
        if (((gDisplayListContext->usedModelViewMtxs + 30) < 250) &&
            (D_803F2EDA != 0) &&
            ((D_803D5538 != 0) || (tmp = gCameraUiState, tmp == 0) || (tmp == 2) || ((tmp == 1) && (D_803F2AA3 > 10))) &&
            ...
            func_8038C230_79D8E0((s16) ((s32) (D_803D5524->height * 8) / 5), 2, 3, 3, -0.32f);
            ...
            if (D_803D552C->unk316 != 0) {
                guRotate(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs], D_803D552C->unk316, 0.0f, 0.0f, 1.0f);
            ...
            if (D_803D5524->animalType == MOUSE) {
            ...
            if (gLodDetailState == 0) {
                ...
                func_80356BD8_768288(&img_eyes_TLUT1_pal, (u8 (*)[128])img_eyes5_ci4__png, sp88);
    ...
    if ((sp86 == 0) || (sp86 == 2)) {
        func_8034BD20_75D3D0(D_803D552C->position.xPos.h, D_803D552C->position.zPos.h, (s16) (D_803D552C->position.yPos.h + ((s32) (D_803D5524->height * 7) >> 3)), D_803D552C->heading, img_D_01033190_6CA60_i4__png, (s16) 7, (s16) 7, (s16) 0x9B, 0, 0, 0, (s16) 0, (s16) (s32) D_803D5538);
    }
    ...
    if (sp96 != 0) {
        if ((sp86 == 0) && (D_803F2EDB != 0)) {
            ...
            if (D_803E00C0[D_803D5528->unk3C8.unk2].needsRecurve == 1) {
                if (D_803E00C0[D_803D5528->unk3C8.unk2].tailType == TAIL_TYPE_MOUSE) {
    ...
    if ((D_803D5538 == 0) && (D_803D5524->animalType == MOUSE2)) {
...
void func_8031D624_72ECD4(void) {
    ...
    if ((sp92 != 4) && (sp92 != 1) && (D_803D5530->movementState == MOVEMENT_STATE_GROUND)) {
        temp_f12 = sqrtf(SQ((f32)D_803D552C->xVelocity.w) + SQ((f32)D_803D552C->zVelocity.w)) / (D_803D5524->walkSpeed << 0xA);
        if (temp_f12 < 0.2) {
            phi_f0 = 0.0f;
        } else if (0.6 < temp_f12) {
            phi_f0 = 1.0f;
        } else {
            phi_f0 = (temp_f12 - 0.2) * 2.5;
        }
        if (phi_f0 > 0.0) {
            if (D_803D5530->unk4A == 0) {
    ...
    if (sp92 == 0) {
        ...
        if (((gDisplayListContext->usedModelViewMtxs + 30) < 250) &&
            ...
            func_8038C230_79D8E0(((D_803D5524->height * 8) / 5), 2, 3, 3, -0.32f);
            ...
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(7, 8, FTOFIX32(0.15625), FTOFIX32(0.15625), FTOFIX32(0.15625), D_803F2ED0, 0, 0, 0, D_04005CA0_CD6D0); }
            ...
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(16, 17, FTOFIX32(0.15625), FTOFIX32(0.15625), FTOFIX32(0.15625), D_803F2ED0, 0, 0, 0, D_04005CA0_CD6D0); }
    ...
    if ((sp92 == 0) || (sp92 == 2)) {
        func_8034BD20_75D3D0(
            D_803D552C->position.xPos.h,
            D_803D552C->position.zPos.h,
            D_803D552C->position.yPos.h + ((D_803D5524->height * 7) >> 3),
            D_803D552C->heading,
    ...
    if (0) {
        // Synray hack:
        spAE = (spAE == 1 ? spAE == 2 ? spAE == 3 ? spAE == 3 ? spAE == 3 ? 1 : 2 : 3 : 4: 5: 6);
    }
}
...
void func_8031E6A0_72FD50(void) {
    ...
    if ((D_803D5538 != 0) && (CHECK_SEGMENT != 0)) {
        ...
        spA6 = classify_object_visibility(
            D_803D552C->position.xPos.w,
            D_803D552C->position.zPos.w,
            D_803D552C->position.yPos.w + (D_803D5524->height << 0xF),
            0x640,
    ...
    if (spA6 == 0) {
        ...
        func_8035D734_76EDE4();
        if (D_803D5528->unk3C8.unk2 != 0) {
            D_803E00C0[D_803D5528->unk3C8.unk2].tailType = TAIL_TYPE_MOUSE_SPIN;
        }
        ...
        case ATTACK_MOUSE_TAIL:
            spA8 = gGameplayTick - D_803D552C->unk32A;
            spAA = spA8 * 21;
            if (spA8 >= 6) {
                D_803D552C->unk365 = ATTACK_MOUSE_3;
                D_803D552C->unk32A = gGameplayTick;
        ...
        if (((gDisplayListContext->usedModelViewMtxs + 30) < 250) &&
            ...
            gDPSetPrimColor(gOpaqueDL++, 0, 0, 0xFF, 0x99, 0x99, 0xFF);
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(7, 8, FTOFIX32(0.15625), FTOFIX32(0.15625), FTOFIX32(0.15625), D_803F2ED0, 0, 0, 0, D_04005CA0_CD6D0); } // racing mouse wheel
            ...
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(16, 17, FTOFIX32(0.15625), FTOFIX32(0.15625), FTOFIX32(0.15625), D_803F2ED0, 0, 0, 0, D_04005CA0_CD6D0); } // racing mouse wheel
            ...
            guLookAtReflect(
                ...
                &gDisplayListContext->unk38A50[gDisplayListContext->unk39310],
                gCameraEyeWorldX,
                gCameraEyeWorldZ,
                gCameraEyeWorldY,
            ...
            gDPSetTextureLUT(gOpaqueDL++, G_TT_NONE);
            gSPLookAtX(gOpaqueDL++, &gDisplayListContext->unk38A50[gDisplayListContext->unk39310].l[0]);
            gSPLookAtY(gOpaqueDL++, &gDisplayListContext->unk38A50[gDisplayListContext->unk39310].l[1]);
            gDPPipeSync(gOpaqueDL++);
            gDisplayListContext->unk39310++;

            gSPDisplayList(gOpaqueDL++, D_01004270_3DB40);
            gSPDisplayList(gOpaqueDL++, D_01004AF8_3E3C8);
            gDPSetRenderMode(gOpaqueDL++, gRenderMode1, G_RM_AA_ZB_OPA_SURF2);
            gDPSetTextureImage(gOpaqueDL++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, img_silver_rgba16__png);
            gDPSetTile(gOpaqueDL++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0x0000, G_TX_LOADTILE, 0, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD);
            gDPLoadSync(gOpaqueDL++);
            gDPLoadBlock(gOpaqueDL++, G_TX_LOADTILE, 0, 0, 1023, 256);
            gDPPipeSync(gOpaqueDL++);
            gDPSetTile(gOpaqueDL++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0x0000, G_TX_RENDERTILE, 0, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, 5, G_TX_NOLOD);
            gDPSetTileSize(gOpaqueDL++, G_TX_RENDERTILE, 0, 0, 4*(31), 4*(31));

            func_802C78B0_6D8F60(2, 1, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, (D_803F2EC8 * 0xA) >> 6, D_803F2ED0, 0, 0, 0, D_04005480_CCEB0); // mouse tail
            gSPDisplayList(gOpaqueDL++, D_01003460_3CD30);
            gSPPopMatrix(gOpaqueDL++, G_MTX_MODELVIEW);
        }
        func_8035D6A0_76ED50();
    } else {
    ...
    if ((spA6 == 0) || (spA6 == 2)) {
        func_8034BD20_75D3D0(D_803D552C->position.xPos.h, D_803D552C->position.zPos.h, (D_803D552C->position.yPos.h + ((D_803D5524->height * 7) >> 3)), D_803D552C->heading, img_D_01033190_6CA60_i4__png, 7, 7, 0x9B, 0, 0, 0, 0, D_803D5538);
    }
...
void func_8031FB78_731228(s16 arg0) {
    D_803D552C->unk2EC = arg0;
    if (D_803D5524->animalType == RACING_MOUSE) {
        load_animal(HARD_MOUSE);
        D_803D552C->unk365 = ATTACK_MOUSE_TAIL;
        D_803D552C->unk32A = gGameplayTick;
    }
