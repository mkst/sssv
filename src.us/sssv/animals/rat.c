...
void func_8035E430_76FAE0(void) {
    ...
    if (spA2 == 0) {
        ...
        if (D_803D552C->movementMode == MOVEMENT_MODE_DEACTIVATED) {
            if (D_803D5528->unk3C8.unk2 != 0) {
                if (D_803D5524->animalType == RAT) {
                    D_803E00C0[D_803D5528->unk3C8.unk2].tailType = TAIL_TYPE_MOUSE_DEAD;
                } else {
                    D_803E00C0[D_803D5528->unk3C8.unk2].tailType = TAIL_TYPE_KING_RAT_DEAD;
                }
            }
            ...
            if (D_803D5528->unk3C8.unk2 != 0) {
                if (D_803D5524->animalType == RAT) {
                    ...
                    D_803E00C0[D_803D5528->unk3C8.unk2].tailType = TAIL_TYPE_KING_RAT;
                }
            }
        }
            ...
            case ATTACK_BITE:
                ...
                if (ticks_remaining == 2) {
                    if (func_803224C4_733B74(6, 25, 0, 22, 6, 40, 300, 7)) {
                        ...
                        play_sound_effect_at_location(SFX_UNKNOWN_6, 0x5000, 0, D_803D5530->position.xPos.h, D_803D5530->position.zPos.h, D_803D5530->position.yPos.h, 1.3f);
                    }
        ...
        case KING_RAT:
            ...
            case ATTACK_FART_CLOUD:
                create_particle_effect(
                    D_803D5530->position.xPos.h + (SSSV_RAND(32) - 16),
                    D_803D5530->position.zPos.h + (SSSV_RAND(32) - 16),
                ...
                if (D_803D5530->unk4A == 0) {
                    func_8032CD70_73E420(
                        ...
                        0x5000,
                        0,
                        ((SIN(D_803D5540 << 3) >> 7) / 1000.0) + 2.25,
        ...
        if (((gDisplayListContext->usedModelViewMtxs + 0x1E) < 250) &&
            (D_803F2EDA != 0) && ((D_803D5538 != 0) || (temp_v0_9 = gCameraUiState, (temp_v0_9 == 0)) || (temp_v0_9 == 2) || ((temp_v0_9 == 1) && (D_803F2AA3 >= 0xB))) &&
            ...
            gDPSetPrimColor(gOpaqueDL++, 0, 0, 0xFF, 0x80, 0x80, 0xFF);
            ...
            // rat wheels?
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(7,  8,  FTOFIX32(0.8125), FTOFIX32(0.8125), FTOFIX32(0.8125), D_803F2ED0, 0, 0, 0, D_040072F0_CED20); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(10, 11, FTOFIX32(0.8125), FTOFIX32(0.8125), FTOFIX32(0.8125), D_803F2ED0, 0, 0, 0, D_040072F0_CED20); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(13, 14, FTOFIX32(0.8125), FTOFIX32(0.8125), FTOFIX32(0.8125), D_803F2ED0, 0, 0, 0, D_040072F0_CED20); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(16, 17, FTOFIX32(0.8125), FTOFIX32(0.8125), FTOFIX32(0.8125), D_803F2ED0, 0, 0, 0, D_040072F0_CED20); }
            ...
            if (spA6 != 5) {
                ...
                gDPSetPrimColor(gOpaqueDL++, 0, 0, 0x9B, 0x00, 0x00, 0xFF);
            }
    ...
    if ((spA2 == 0) || (spA2 == 2)) {
        func_8034BD20_75D3D0(D_803D552C->position.xPos.h, D_803D552C->position.zPos.h, D_803D552C->position.yPos.h + D_803D5524->height, D_803D552C->heading, img_D_01033190_6CA60_i4__png, (scale * 0x28A) / 32, (scale * 0x177) / 32, 0x9B, 0, 0, 0, 0, D_803D5538);
    }
    ...
    if ((D_803D5538 == 0) && (D_803D5524->animalType == KING_RAT)) {
        switch (D_803D552C->unk365) {
        case ATTACK_FART_CLOUD:
