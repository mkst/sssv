...
void func_80365F10_7775C0(void) {
        ...
        if (D_803D5538 != 0) {
            if (D_803D552C->unk369 == 0) {
                ...
                if ((D_801E9E8A != 0) && (D_803D552C->unk36D >= 6)) {
                    ...
                    play_sound_effect_at_location(SFX_UNKNOWN_32, 0x5000, 0, D_803D5530->xPos.h, (s16) (s32) D_803D5530->zPos.h, (s16) (s32) D_803D5530->yPos.h, 1.0f);
                }
    ...
    spB2 = func_802E89F0_6FA0A0(D_803D552C->xPos.w, D_803D552C->zPos.w, D_803D552C->yPos.w + (D_803D5524->unkBA << 0xF), 0x17E8, (u8) 5, (s16) 0xB4, (s16) 0xB4, (s16) 0xB4, (s8) 2, (u8) (var_v0_3 == 0));
...
block_39:
    if (spB2 == 0) {
        ...
        if ((D_803F2ECE == 0) || (D_803F2ECC < 31)) {
            ...
            func_802BF3C0_6D0A70(0x344, 0x2F, 0, 0x64, 0, 0x80, D_803B4250_7C5900, D_803B4280_7C5930, &D_803B42B0_7C5960, 0x344, 0x2F, 0x64, 0, 0x80, 0, D_803B4250_7C5900, D_803B4280_7C5930, D_803B42B0_7C5960, &spB8);
        ...
        if (((D_80204278->usedModelViewMtxs + 0x1E) < 250) && (D_803F2EDA != 0) && (((D_803D5538 != 0)) || (temp_v0_11 = D_803F2AA2, (temp_v0_11 == 0)) || (temp_v0_11 == 2) || ((temp_v0_11 == 1) && ((s32) D_803F2AA3 >= 0xB))) && ((D_803F2C18[0] != 0) || (D_803D5538 == 0) || (((D_803F28E0[D_803F2A98].cameraMode != 3)) && (D_803F28E0[D_803F2A98].cameraMode != 0x11)) || (D_803F28E0[D_803F2A98].unk64 != -3))) {
            ...
            if (D_803D552C->unk364 == 3) {
                temp_t7 = (D_803D5544 - D_803D552C->unk334);
                spA4 = D_803B4338_7C59E8[MIN(temp_t7, 15)];
                create_particle_effect(
                    (SSSV_RAND(64) + D_803D5530->xPos.h) - 0x20,
                    (SSSV_RAND(64) + D_803D5530->zPos.h) - 0x20,
                    (SSSV_RAND(64) + D_803D5530->yPos.h + (D_803D5530->unk42 >> 1)) - 0x20,
                    0x15,
                    0,
                    0,
                    0,
            ...
            func_80127640(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs], D_803D5530->xPos.w, D_803D5530->zPos.w, D_803D5530->yPos.w, (s16) (s32) -spAA, (s32) D_803F2EB0 / 4, (s32) D_803F2EB4 / 4, (s32) D_803F2EB8 / 4, (s16) (s32) D_803F2ED2, D_803F2ED4);
            ...
            case POLAR_BEAR:                                /* switch 2 */
                if ((D_803D552C->unk365 == ATTACK_POLAR_BEAR_2) || (D_803D552C->unk365 == ATTACK_POLAR_BEAR_3)) {
                    func_802C78B0_6D8F60(2, 1, (D_803F2EBC * 0x99) >> 6, (D_803F2EC0 * 0x99) >> 6, (D_803F2EC4 * 0x99) >> 6, D_803F2ED0, 0, 0, 0, &D_04002D78);
                } else {
...
#pragma _permuter sameline end
                    ...
                    func_802C78B0_6D8F60(19, 20, (spAE * 0x9900) >> 6, (spAE * 0x9900) >> 6, (spAE * 0x9900) >> 6, D_803F2ED0, 0, 0, 0, &D_04003760);
                }
                break;
            case POLAR_BEAR_DEFENDING:                                 /* switch 2 */
                func_80368840_779EF0(32);
                func_802C78B0_6D8F60(2, 1, (s32) (D_803F2EBC * 0x99) >> 6, (s32) (D_803F2EC0 * 0x99) >> 6, (s32) (D_803F2EC4 * 0x99) >> 6, D_803F2ED0, 0, 0, 0, &D_04002D78);
                if (D_803D5540 < 0x50) {
...
#pragma _permuter sameline end
                        ...
                        func_80356BD8_768288(&D_01000CA0, &D_01002100, spB4);
                        func_802C78B0_6D8F60(0x13, 0x14, 0x1CB00, 0x1CB00, 0x1CB00, D_803F2ED0, 0, 0, 0, &D_04003760);
                    }
                }
                if (D_803D5540 != 0) {
                    if ((D_803D5530->state == 2) && (D_803D5530->xVelocity.h == 0) && (D_803D5530->zVelocity.h == 0)) {
                        if (ABS(D_803D5530->yVelocity.h) < 6) {
                            if ((D_803D5540 == 0x78) || (D_803D5540 == 0xAA)) {
                                play_sound_effect_at_location(SFX_UNKNOWN_24, 0x5000, 0, D_803D5530->xPos.h, (s16) (s32) D_803D5530->zPos.h, (s16) (s32) D_803D5530->yPos.h, 1.0f);
                                create_particle_effect(
                                    D_803D5530->xPos.h,
                                    D_803D5530->zPos.h,
                            ...
                            if ((D_803D5540 == 0x91) || (D_803D5540 == 0xC3)) {
                                play_sound_effect_at_location(SFX_UNKNOWN_25, 0x5000, 0, D_803D5530->xPos.h, (s16) (s32) D_803D5530->zPos.h, (s16) (s32) D_803D5530->yPos.h, 1.0f);
                                create_particle_effect(
                                    D_803D5530->xPos.h,
                                    D_803D5530->zPos.h,
                                    D_803D5530->yPos.h + D_803D5530->unk42,
    ...
    if ((spB2 == 0) || (spB2 == 2)) {
        func_8034BD20_75D3D0(D_803D552C->xPos.h, D_803D552C->zPos.h, (s16) (D_803D552C->yPos.h + ((s32) D_803D5524->unkBA >> 1)), D_803D552C->unk302, &D_01033190, (s16) 0x22, (s16) 0x22, (s16) 0x9B, 0, 0, 0, (s16) 0, (s16) (s32) D_803D5538);
    }
    if (spB2 == 0) {
        ...
        D_803D5530->unkC0.b.unkCC += 22;
        D_803D5530->unkC0.b.unkDC += 22;
        D_803D5530->unkC0.b.unkEC += 22;
...
void func_803677C4_778E74(void) {
    ...
    sp92 = func_802E89F0_6FA0A0(D_803D552C->xPos.w, D_803D552C->zPos.w, D_803D552C->yPos.w + (D_803D5524->unkBA << 0xF), 0x17E8, (u8) 5, (s16) 0xB4, (s16) 0xB4, (s16) 0xB4, (s8) 2, var_v1_2 == 0);
    ...
    if (sp92 == 0) {
        ...
        if (D_803D552C->unk365 == 0x1A) {
            ...
            if (temp_t7 < 6) {
                D_803D552C->unk308 -= 3;
                if (temp_t7 == 5) {
                    func_80321E60_733510(0x11, 0x5A, 0, 0x34, (s16) 0x17, (s16) 0, (s16) 2, (s16) 0x1E);
                    D_803D552C->unk308 = MIN(0x2E, D_803D552C->unk308 + 0x1E);
                    func_803421E0_753890(0x14);
                    play_sound_effect_at_location(0x1B, 0x7FFF, 0, D_803D5530->xPos.h, (s16) (s32) D_803D5530->zPos.h, (s16) (s32) D_803D5530->yPos.h, 1.0f);
                }
            } else {
                D_803D552C->unk365 = 0;
            }
        ...
        if ((D_803F2ECE == 0) || (D_803F2ECC < 0x1F)) {
            ...
            D_80203FE0[19].unk2 -= (D_803D552C->unk308 * 0x3BC) >> 5;
            D_80203FE0[20].unk2 -= (D_803D552C->unk308 * 0x3BC) >> 5;
            func_802C7600_6D8CB0(0x3BC, 8);
        }
        if (D_803F2ECC != 0) {
            func_802DB8DC_6ECF8C();
        ...
        if (((D_80204278->usedModelViewMtxs + 0x1E) < 0xFA) && (D_803F2EDA != 0) && ((D_803D5538 != 0) || (temp_v0_8 = D_803F2AA2, (temp_v0_8 == 0)) || (temp_v0_8 == 2) || ((temp_v0_8 == 1) && ((s32) D_803F2AA3 >= 0xB))) && ((D_803F2C18[0] != 0) || (D_803D5538 == 0) || (((D_803F28E0[D_803F2A98].cameraMode != 3)) && (D_803F28E0[D_803F2A98].cameraMode != 0x11)) || (D_803F28E0[D_803F2A98].unk64 != -3))) {
            ...
            func_80127640(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs], D_803D5530->xPos.w, D_803D5530->zPos.w, D_803D5530->yPos.w,  (-D_803D552C->unk302) & 0xFF, (s32) D_803F2EB0 / 4, (s32) D_803F2EB4 / 4, (s32) D_803F2EB8 / 4, (s16) (s32) D_803F2ED2, D_803F2ED4);
            gSPMatrix(D_801D9E88++, OS_K0_TO_PHYSICAL(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs++]), G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
...
#pragma _permuter sameline end
                ...
                func_802C78B0_6D8F60(0x13, 0x14, 0x26400, 0x26400, 0x26400, D_803F2ED0, 0, 0, 0, D_04003760);
            }
    ...
    if ((sp92 == 0) || (sp92 == 2)) {
        func_8034BD20_75D3D0(D_803D552C->xPos.h, D_803D552C->zPos.h, (D_803D552C->yPos.h + (D_803D5524->unkBA >> 1)), D_803D552C->unk302, (Gfx*)D_01033190, (s16) 0x28, (s16) 0x1F, (s16) 0x9B, 0, 0, 0, (s16) 0, (s16) (s32) D_803D5538);
    }
    if (sp92 == 0) {
        ...
        if ((D_803D552C->unk366 == 2) || (D_803D552C->unk366 == 5)) {
            D_803D5530->unkC0.b.unkCC -= 0x1D;
        }
        D_803D5530->unkC0.b.unkD4 = D_803D5530->unkC0.b.unkC4; //[0][2];
        D_803D5530->unkC0.b.unkD8 = D_803D5530->unkC0.b.unkC8; //[0][4];
        D_803D5530->unkC0.b.unkDC = D_803D5530->unkC0.b.unkCC; //[0][6];
        D_803D5530->unkC0.b.unkE0 = D_803D5530->unkC0.b.unkD0;
...
void func_80368BA0_77A250(void) {
    if ((D_803D5530->unk162 == 1) && (D_803D5530->unk6C == 0)) {
        spawn_temporary_object(D_803D5530->xPos.h, D_803D5530->zPos.h, D_803D5530->yPos.h, 0x599, 0xB4, D_803D5530, 50, OBJECT_MINE);
...
void polar_tank_drop_mine(void) {
    if ((D_803D5530->unk162 == 1) && (D_803D5530->unk6C == 0)) {
        spawn_temporary_object(D_803D5530->xPos.h, D_803D5530->zPos.h, D_803D5530->yPos.h, 0x599, 0xDC, D_803D5530, 50, OBJECT_MINE);
        play_sound_effect_at_location(SFX_UNKNOWN_38, 0x5000, 0, D_803D5530->xPos.h, D_803D5530->zPos.h, D_803D5530->yPos.h, 1.0f);
    }
}
