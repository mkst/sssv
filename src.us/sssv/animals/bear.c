...
block_9:
    if (spB4 == 0) {
        ...
        if (D_803D5530->state == 0xDD) {
            ...
            D_803F2ECC = MIN(0x20, ((D_80152C78[((s16)(D_803D552C->unk30C << 2) + 0x40) & 0xFF] >> 7) >> 4) + 0x11);
            D_803F2ECE = 0xB;
        }
        ...
        case ATTACK_BEAR_2:                                    /* switch 1 */
            ...
            if (temp_t8 < 21) {
                spB0 += ((D_80152C78[(s16)(temp_t8 << 2) & 0xFF] >> 7) * (spB2 + 0xF)) >> 8;
                spB2 = (((D_80152C78[((s16)(temp_t8 << 2) + 0x40) & 0xFF] >> 7) * spB2) >> 8);
                D_803F2ECE = 9;
                D_803F2ECC = MAX(1, (temp_t8 << 5) / 20);
                if (temp_t8 == 20) {
                    if (D_803D5530->state < 8) {
                        func_802A4390_6B5A40();
                    }
                ...
                D_803F2ECE = 10;
                D_803F2ECC = 32 - (((temp_t8 - 20) * 32) / 10);
            } else if (temp_t8 < 40) {
                D_803F2ECE = 3;
                D_803F2ECC = 32 - (((temp_t8 - 30) * 32) / 10);
            } else {
                D_803D552C->unk365 = ATTACK_NONE;
            }
            break;
        case ATTACK_BEAR_3:                                    /* switch 1 */
            ...
            if (temp_t8 == 4) {
                if (func_8033C9CC_74E07C(
                        ...
                        ((((D_803D552C->yPos.h * 3) >> 1) - (D_803D5530->yPos.h >> 1)) + (D_803D552C->unk42 >> 1)),
                        0x7F,
                        0,
                        0) == 0) {
                    if (D_803D5530->state < 8) {
        ...
        if ((D_803F2ECE == 0) || (D_803F2ECC < 0x1F) || (D_803F2ECE >= 3)) {
            ...
            if (D_803D5530->unk162 == 5) {
                ...
                D_80203FE0[8].unk2 =  D_80203FE0[7].unk2 + (((D_80152C78[(tmp + 0x40) & 0xFF] >> 7) * 0x91E) >> 8);
                D_80203FE0[8].unk4 =  D_80203FE0[7].unk4 - (((D_80152C78[tmp & 0xFF] >> 7) * 0x91E) >> 8);

                tmp = tmp + 0x50;
                D_80203FE0[11].unk2 = D_80203FE0[10].unk2 + (((D_80152C78[(tmp + 0x40) & 0xFF] >> 7) * 0x91E) >> 8);
                D_80203FE0[11].unk4 = D_80203FE0[10].unk4 - (((D_80152C78[tmp & 0xFF] >> 7) * 0x91E) >> 8);
        ...
        if (((D_80204278->usedModelViewMtxs + 0x1E) < 0xFA) && (D_803F2EDA != 0) && (((D_803D5538 != 0)) || (temp_v0_10 = D_803F2AA2, (temp_v0_10 == 0)) || (temp_v0_10 == 2) || ((temp_v0_10 == 1) && ((s32) D_803F2AA3 >= 0xB))) && ((D_803F2C18[0] != 0) || (D_803D5538 == 0) || (((D_803F28E0[D_803F2A98].cameraMode != 3)) && (D_803F28E0[D_803F2A98].cameraMode != 0x11)) || (D_803F28E0[D_803F2A98].unk64 != -3))) {
            if (D_803D5530->state == 0xDD) {
                func_802E497C_6F602C(D_803D552C->unk308, &spC4, &spC0, &spBC);
                guTranslate(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs], D_803D5530->xPos.w / 65536.0, D_803D5530->zPos.w / 65536.0, D_803D5530->yPos.w / 65536.0);
...
#pragma _permuter sameline end
    ...
    if (spB4 == 0) {
        ...
        if (((!(&D_803F2D50)) && (!(&D_803F2D50))) && (!(&D_803F2D50))) {}; // regalloc helper?
...
block_9:
    if (spC2 == 0) {
        ...
        if (((D_80204278->usedModelViewMtxs + 0x1E) < 0xFA) && (D_803F2EDA != 0) && (((D_803D5538 != 0)) || (temp_v0_9 = D_803F2AA2, (temp_v0_9 == 0)) || (temp_v0_9 == 2) || ((temp_v0_9 == 1) && (D_803F2AA3 >= 0xB))) && ((D_803F2C18[0] != 0) || (D_803D5538 == 0) || (((D_803F28E0[D_803F2A98].cameraMode != 3)) && (D_803F28E0[D_803F2A98].cameraMode != 0x11)) || (D_803F28E0[D_803F2A98].unk64 != -3))) {
            ...
            func_8032E150_73F800(&D_801D9EB8, spBC + (D_80152C78[((D_803D5540 << 3) + 0)    & 0xFF] * 11), spB8 + (D_80152C78[((D_803D5540 << 3) + 0x40) & 0xFF] * 9),  spB4 - (D_80152C78[((D_803D5540 << 5) + 0   ) & 0xFF] * 4), 0x10, 0x10, 0x898);
            func_8032E150_73F800(&D_801D9EB8, spBC - (D_80152C78[((D_803D5540 << 3) + 0x80) & 0xFF] * 12), spB8 + (D_80152C78[((D_803D5540 << 3) + 0x40) & 0xFF] * 9),  spB4 + (D_80152C78[((D_803D5540 << 5) + 0x80) & 0xFF] * 4), 0x10, 0x10, 0x898);
            func_8032E150_73F800(&D_801D9EB8, spBC + (D_80152C78[((D_803D5540 << 3) + 0x40) & 0xFF] *  9), spB8 + (D_80152C78[((D_803D5540 << 3) + 0   ) & 0xFF] * 12), spB4 + (D_80152C78[((D_803D5540 << 4) + 0   ) & 0xFF] * 4), 0x10, 0x10, 0x898);
            func_8032E150_73F800(&D_801D9EB8, spBC - (D_80152C78[((D_803D5540 << 3) + 0x40) & 0xFF] * 10), spB8 - (D_80152C78[((D_803D5540 << 3) + 0x80) & 0xFF] * 11), spB4 - (D_80152C78[((D_803D5540 << 4) + 0   ) & 0xFF] * 4), 0x10, 0x10, 0x898);
            func_8032E150_73F800(&D_801D9EB8, spBC + (D_80152C78[((D_803D5540 << 3) + 0)    & 0xFF] * 11), spB8 + (D_80152C78[((D_803D5540 << 3) + 0   ) & 0xFF] * 10), spB4 + (D_80152C78[((D_803D5540 << 5) + 0x40) & 0xFF] * 3), 0x10, 0x10, 0x898);
            func_8032E150_73F800(&D_801D9EB8, spBC - (D_80152C78[((D_803D5540 << 3) + 0x40) & 0xFF] * 10), spB8 - (D_80152C78[((D_803D5540 << 3) + 0x40) & 0xFF] * 10), spB4 + (D_80152C78[((D_803D5540 << 4) + 0x80) + 0x40 & 0xFF] * 4), 0x10, 0x10, 0x898);
...
void func_80326260_737910(void) {
    ...
    if ((ABS(D_803D552C->xPos.h - (s16) (s32) D_803F28E0[D_803F2A98].unk74) < 0x3C0) && (ABS(D_803D552C->zPos.h - (s16) (s32) D_803F28E0[D_803F2A98].unk78) < 0x3C0)) {
        spB2 = 0;
        goto block_9;
    }
    ...
    spB2 = func_802E89F0_6FA0A0(D_803D552C->xPos.w, D_803D552C->zPos.w, D_803D552C->yPos.w + (D_803D5524->unkBA << 0xF), 0x18A4, (u8) 6, (s16) 0x6D, (s16) 0x27, (s16) 0, (s8) 2, var_a0 == 0);

block_9:
    if ((spB2 != 4) && (spB2 != 1) && (D_803D5530->unk162 == 1)) {
        temp_f2_2 = (f64) (sqrtf(SQ((f32)D_803D552C->xVelocity.w) + SQ((f32)D_803D552C->zVelocity.w)) / (f32) (D_803D5524->unkA4 << 0xA));
        if (temp_f2_2 < 0.2) {
            var_f0 = 0.0f;
...
#pragma _permuter sameline end
            ...
            func_8034C8F8_75DFA8(
                D_803D552C->xPos.h + ((D_80152C78[(D_803D5540 + 0x40) & 0xFF] >> 7) >> 1),
                D_803D552C->zPos.h + ((D_80152C78[D_803D5540 & 0xFF] >> 7) >> 2),
                D_803D552C->yPos.h + 0x100,
                0,
                D_01033190,
                0x7D,
                0x7D,
                ...
                D_803D5538);
            func_8034C8F8_75DFA8(
                D_803D552C->xPos.h + ((D_80152C78[(D_803D5540 + 0x5E) & 0xFF] >> 7) >> 2),
                D_803D552C->zPos.h - ((D_80152C78[D_803D5540 & 0xFF] >> 7) >> 1),
                D_803D552C->yPos.h + 0x100,
                0,
                D_01033190,
                0x7D,
            ...
            if ((D_803D552C->unk366 != 2) && (D_803D552C->unk366 != 5)) {
                ...
                add_light_at_location(
                    D_803D552C->xPos.h + ((D_80152C78[(s16)(D_803D5540 + 0x40) & 0xFF] >> 7) >> 1),
                    D_803D552C->zPos.h + ((D_80152C78[D_803D5540 & 0xFF] >> 7) >> 2),
                    D_803D552C->yPos.h - 0x20,
                    0xFF,
                    0xFF,
                    0,
                    0xFF);
                // add pink light (r+b)
                add_light_at_location(
                    D_803D552C->xPos.h + ((D_80152C78[(s16)(D_803D5540 + 0x5E) & 0xFF] >> 7) >> 2),
                    D_803D552C->zPos.h - ((D_80152C78[D_803D5540 & 0xFF] >> 7) >> 1),
                    D_803D552C->yPos.h - 0x20,
                    0xFF,
                    0,
                ...
                temp_t8 = -D_803D552C->unk302;
                spB8 = D_80152C78[(s16)(temp_t8 + 0x40) & 0xFF] >> 7;
                ...
                for (i = 0; i < 3; i++) {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        var_t0_5 = (D_803D5540 + 85) & 0xFF;
                        break;
                    case 2:
                        var_t0_5 = (D_803D5540 + 171) & 0xFF;
                        break;
                    }

                    var_v0_2 = var_t0_5 & 0x1F;
                    if (((var_v0_2) == 10) || ((var_v0_2) == 20)) {
                        play_sound_effect_at_location(0, 0x4000, 0, D_803D5530->xPos.h, D_803D5530->zPos.h, D_803D5530->yPos.h, 1.0f);
                    }

                    temp_t9_3 = ((D_80152C78[(s16)(var_t0_5 * 4) & 0xFF] >> 7) * 0xA6) / 4;
                    tmp = (((D_80152C78[(s16)(var_t0_5 * 8) & 0xFF] >> 7) * 0xA6 * 0x180) / 4);
                    func_8029CEF0_6AE5A0(
                        (D_803D5530->xPos.w + (spB8 * temp_t9_3)) - sp5C,
                        (D_803D5530->zPos.w + (spBC * temp_t9_3)) + sp4C,
                        D_803D5530->yPos.w + tmp + 0xADC800,
                        612,
                        i + 3,
                        &D_803D2E08,
                        i + 3,
    ...
    if ((spB2 == 0) || (spB2 == 2)) {
        func_8034BD20_75D3D0(D_803D552C->xPos.h, D_803D552C->zPos.h, (s16) (D_803D552C->yPos.h + ((s32) D_803D5524->unkBA >> 1)), D_803D552C->unk302, (Gfx *) D_01033190, (s16) 0x19, (s16) 0x19, (s16) 0x9B, 0, 0, 0, (s16) 0, (s16) (s32) D_803D5538);
    }
    if (spB2 == 0) {
        func_80303820_714ED0(D_803D552C, 1, 2, 0x3CC, 0);
