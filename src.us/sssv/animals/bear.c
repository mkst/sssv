...
#pragma _permuter sameline end
    ...
    if ((spB4 == VISIBILITY_VISIBLE) || (spB4 == VISIBILITY_OUT_OF_BOUNDS_X)) {
        func_8034BD20_75D3D0(D_803D552C->position.xPos.h, D_803D552C->position.zPos.h, D_803D552C->position.yPos.h + (D_803D5524->unkBA >> 1), D_803D552C->heading, img_D_01033190_6CA60_i4__png, (s16) 0x19, (s16) 0x19, (s16) 0x9B, 0, 0, 0, (s16) 0, (s16) (s32) D_803D5538);
    }
    if (spB4 == VISIBILITY_VISIBLE) {
...
void update_crazy_bear(void) {
    ...
    if (spC2 == VISIBILITY_VISIBLE) {
        ...
        func_8038064C_791CFC();
        if (((D_80204278->usedModelViewMtxs + 30) < 250) && (D_803F2EDA != 0) && ((D_803D5538 != 0) || (temp_v0_9 = gCameraUiState, (temp_v0_9 == 0)) || (temp_v0_9 == 2) || ((temp_v0_9 == 1) && (D_803F2AA3 >= 0xB))) && ((D_803F2C18[0] != 0) || (D_803D5538 == 0) || (((gCameras[gCameraId].cameraMode != 3)) && (gCameras[gCameraId].cameraMode != 0x11)) || (gCameras[gCameraId].unk64 != -3))) {
...
void func_80326260_737910(void) {
    ...
    if (spB2 == VISIBILITY_VISIBLE) {
        ...
        if ((D_803D552C->unk320 == NULL) && (D_801D9ED8.curBButton != 0) && (((D_803D5530->state == 2)) || (D_803D5530->state == 3))) {
            D_803F2ECC = 0x20;
            D_803F2ECE = 3;
        }
        if (D_803F2ECC != 0) {
        ...
        func_8038064C_791CFC();
        if (((D_80204278->usedModelViewMtxs + 0x1E) < 0xFA) && (D_803F2EDA != 0) && (((D_803D5538 != 0)) || (temp_v0_8 = gCameraUiState, (temp_v0_8 == 0)) || (temp_v0_8 == 2) || ((temp_v0_8 == 1) && (D_803F2AA3 >= 0xB))) && ((D_803F2C18[0] != 0) || (D_803D5538 == 0) || (((gCameras[gCameraId].cameraMode != 3)) && (gCameras[gCameraId].cameraMode != 0x11)) || (gCameras[gCameraId].unk64 != -3))) {
            func_80127640(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs], D_803D5530->position.xPos.w, D_803D5530->position.zPos.w, D_803D5530->position.yPos.w, -D_803D552C->heading, D_803F2EB0 / 4, D_803F2EB4 / 4, D_803F2EB8 / 4, D_803F2ED2, D_803F2ED4);
            gSPMatrix(D_801D9E88++, OS_K0_TO_PHYSICAL(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs++]), G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
...
#pragma _permuter sameline end
    ...
    if ((spB2 == VISIBILITY_VISIBLE) || (spB2 == VISIBILITY_OUT_OF_BOUNDS_X)) {
        func_8034BD20_75D3D0(D_803D552C->position.xPos.h, D_803D552C->position.zPos.h, D_803D552C->position.yPos.h + (D_803D5524->unkBA >> 1), D_803D552C->heading, (Gfx *) img_D_01033190_6CA60_i4__png, 0x19, 0x19, 0x9B, 0, 0, 0, 0, D_803D5538);
    }
    if (spB2 == VISIBILITY_VISIBLE) {
        func_80303820_714ED0(D_803D552C, 1, 2, 0x3CC, 0);
