...
#pragma GLOBAL_ASM("asm/nonmatchings/sssv/animals/heli_rabbit/func_80300210_7118C0.s")

#pragma GLOBAL_ASM("asm/nonmatchings/sssv/animals/heli_rabbit/func_80301248_7128F8.s")
...
void func_80302080_713730(void) {
    if (D_803D5530->unk162 != 1) {
        ...
        play_sound_effect_at_location(SOUND_EFFECT_DROP_BOMB, 0x4000, 0, D_803D5530->xPos, D_803D5530->zPos, D_803D5530->yPos, 1.0f);
    } else {
        recharge_skill(1);
    }
}
