...
//                     ((D_803F2C18 == 0) && (D_803D5538 != 0)) ||
//                     ((D_803F28E0[D_803F2A98].unk0 == 3) || (D_803F28E0[D_803F2A98].unk0 != 0x11)) ||
//                      (D_803F28E0[D_803F2A98].unk64 != -3)) {
//                     func_80127640(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs], *(s32*)&D_803D5530->xPos, *(s32*)&D_803D5530->zPos, *(s32*)&D_803D5530->yPos, -(s32) D_803D552C->unk302, (s32) D_803F2EB0 / 4, (s32) D_803F2EB4 / 4, (s32) D_803F2EB8 / 4, D_803F2ED2, D_803F2ED4);
...
//                     func_80356410_767AC0(D_04007DD0, D_04007BD0);
...
//     }
//     if ((sp8A == 0) || (sp8A == 2)) {
//         func_8034BD20_75D3D0(D_803D552C->xPos, D_803D552C->zPos, (D_803D552C->yPos + D_803D5524->unkBA), D_803D552C->unk302, D_01033190, 21, 9, 155, 0, 0, 0, 0,  D_803D5538);
//     }
