...
extern Gfx dog_back_detail[];
extern Gfx dog_body[];
extern Gfx dog_foot[];
extern Gfx dog_head[];
extern Gfx dog_left_eye[];
extern Gfx dog_lower_leg[];
extern Gfx dog_missile_pod[];
extern Gfx dog_neck[];
extern Gfx dog_right_eye[];
extern Gfx dog_upper_leg[];

extern Gfx flying_dog_body[];
extern Gfx flying_dog_fire_left[];
extern Gfx flying_dog_fire_right[];
extern Gfx flying_dog_head[];
extern Gfx flying_dog_muzzle_left[];
extern Gfx flying_dog_muzzle_right[];
extern Gfx flying_dog_neck_detail[];
extern Gfx flying_dog_wing[];

extern Gfx racing_dog_leg[];
...
void func_802EA7F0_6FBEA0(void) {
    ...
    if (((D_803D552C->movementMode == MOVEMENT_MODE_INJURED) || (D_803D552C->movementMode == MOVEMENT_MODE_CRITICAL)) && (SSSV_RAND(256) == 0x9C) && (gAnimalBehaviourEnabled != 0)) {
    ...
    if ((D_803D5538 != 0) && (CHECK_SEGMENT != 0)) {
        gLodDetailState = sp92 = 0;
    } else {
        sp92 = classify_object_visibility(
    ...
    if ((sp92 != 4) && (sp92 != 1) && (D_803D5530->movementState == MOVEMENT_STATE_GROUND)) {
        var_f0 = sqrtf(SQ((f32)D_803D552C->xVelocity.w) + SQ((f32)D_803D552C->zVelocity.w)) / (D_803D5524->walkSpeed << 0xA);
        if (var_f0 < 0.2) {
            tmp2 = 0.0f;
        } else if (var_f0 > 0.6) {
            tmp2 = 1.0f;
    ...
    if (sp92 == 0) {
        ...
        if (((gDisplayListContext->usedModelViewMtxs + 30) < 250) && (D_803F2EDA != 0) && (((D_803D5538 != 0)) || (tmp = gCameraUiState, tmp == 0) || (tmp == 2) || ((tmp == 1) && (D_803F2AA3 >= 0xB))) && ((*D_803F2C18 != 0) || (D_803D5538 == 0) || (((gCameras[gCameraId].cameraMode != 3)) && (gCameras[gCameraId].cameraMode != 0x11)) || (gCameras[gCameraId].zoomIndex != -3))) {
            ...
            func_8038C230_79D8E0((D_803D5524->height * 8) / 5, 2, 3, 3, 0.15f);
            load_1_tile(img_dog_body_pal, img_dog_body_ci4__png);
            func_802C78B0_6D8F60(2, 1, (D_803F2EBC << 6) >> 6, (D_803F2EC0 << 6) >> 6, (D_803F2EC4 << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_body);
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(2, 1, ((((D_803D552C->missileScaleLeft + 8) * D_803F2EBC) >> 4) << 6) >> 6, ((((D_803D552C->missileScaleLeft + 8) * D_803F2EC0) >> 4) << 6) >> 6, ((((D_803D552C->missileScaleLeft + 8) * D_803F2EC4) >> 4) << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_missile_pod); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(2, 1, ((((D_803D552C->missileScaleRight + 8) * D_803F2EBC) >> 4) << 6) >> 6, ((((D_803D552C->missileScaleRight + 8) * D_803F2EC0) >> 4) << 6) >> 6, ((((D_803D552C->missileScaleRight + 8) * D_803F2EC4) >> 4) << 6) >> 6, D_803F2ED0, 0, 1, 0, dog_missile_pod); }
            func_802C78B0_6D8F60(0x13, 0x14, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_head);

            if ((D_803D5540 >= 0xB5) && (((D_803D552C->movementMode == MOVEMENT_MODE_INJURED)) || (D_803D552C->movementMode == MOVEMENT_MODE_NORMAL))) {
            ...
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(2, 1, (D_803F2EBC << 6) >> 6, (D_803F2EC0 << 6) >> 6, (D_803F2EC4 << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_back_detail); }
            D_80203FE0[2].unk0 -= sp8E;
            D_80203FE0[1].unk0 -= sp8E;

            if (gLodDetailState == 0) { func_802C78B0_6D8F60(1, 0x13, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_neck); }
            func_802C78B0_6D8F60(7, 8, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, racing_dog_leg);
            func_802C78B0_6D8F60(0xA, 0xB, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0,0, 1, 0, racing_dog_leg);
            ...
            if (gLodDetailState == 0) {
                ...
                func_80356BD8_768288(img_eyes_TLUT2_pal, (u8 (*)[128])img_eyes_ci4__png, sp94);
                func_802C78B0_6D8F60(0x13, 0x14, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_right_eye);
            }
...
void update_flying_dog(void) {
    ...
    if ((D_803D552C->movementMode == MOVEMENT_MODE_2) || (D_803D552C->movementMode == MOVEMENT_MODE_DEACTIVATED)) {
        if ((D_803D5530->movementState == MOVEMENT_STATE_AIRBORNE) && (D_803D5530->unk4A == 0)) {
    ...
    var_a2 = 0x5000;
    spB0 = ((SIN((D_803D5540 + D_803D552C->ambientPhaseSeed) << 3) >> 7) / 16384.0) + (1.15 + (D_803D5530->yVelocity.h / 30.0));
    ...
    if (D_803D552C->unk365 == 0x30) {
        var_a2 += (var_a2 * (SIN((gGameplayTick - D_803D552C->unk32A) * 6) >> 7)) / 512.0;
        spB0 += (spB0 * (SIN((gGameplayTick - D_803D552C->unk32A) * 6) >> 7)) / 1024.0;
    }
    ...
    spD8 = classify_object_visibility(D_803D552C->position.xPos.w, D_803D552C->position.zPos.w, D_803D552C->position.yPos.w + (D_803D5524->height << 0xF), 0x800, 0, 0x9E,0x9E, 0x4F, 1, var_v0_4 == 0);

done:
    if (spD8 == VISIBILITY_VISIBLE) {
        func_8035D120_76E7D0();
        func_8035DA60_76F110();
        func_8035D734_76EDE4();
        spD4 = 0;spD2 = 0;
        ...
        if (((gDisplayListContext->usedModelViewMtxs + 30) < 250) && (D_803F2EDA != 0) && (((D_803D5538 != 0)) || (var_v0_4 = gCameraUiState, (var_v0_4 == 0)) || (var_v0_4 == 2) || ((var_v0_4 == 1) && (D_803F2AA3 >= 0xB))) && ((D_803F2C18[0] != 0) || (D_803D5538 == 0) || ((gCameras[gCameraId].cameraMode != 3) && (gCameras[gCameraId].cameraMode != 0x11)) || (gCameras[gCameraId].zoomIndex != -3))) {
            func_80127640(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs], D_803D5530->position.xPos.w, D_803D5530->position.zPos.w, D_803D5530->position.yPos.w, -D_803D5530->yRotation, 0x4000, 0x4000, 0x4000, D_803F2ED2, D_803F2ED4);
            gSPMatrix(gOpaqueDL++, OS_K0_TO_PHYSICAL(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs++]), G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);

            if ((spD4 != 0) || (spD2 != 0)) {
                guTranslate(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs], 0.0f, 0.0f, D_803D5530->unk42);
                ...
                guRotate(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs], spD4, 1.0f, 0.0f, 0.0f);
                gSPMatrix(gOpaqueDL++, OS_K0_TO_PHYSICAL(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs++]), G_MTX_NOPUSH | G_MTX_MUL | G_MTX_MODELVIEW);

                guRotate(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs], spD2, 0.0f, 1.0f, 0.0f);
                gSPMatrix(gOpaqueDL++, OS_K0_TO_PHYSICAL(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs++]), G_MTX_NOPUSH | G_MTX_MUL | G_MTX_MODELVIEW);
                guTranslate(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs], 0.0f, 0.0f, -D_803D5530->unk42);
                gSPMatrix(gOpaqueDL++, OS_K0_TO_PHYSICAL(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs++]), G_MTX_NOPUSH | G_MTX_MUL | G_MTX_MODELVIEW);
            }

            func_8038C230_79D8E0((D_803D5524->height * 8) / 5, 2, 3, 3, 0.22f);
            load_1_tile(img_flying_dog_body_pal, img_flying_dog_body_ci4__png);
            func_802C78B0_6D8F60( 2,  1, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, flying_dog_body);
            func_802C78B0_6D8F60(19, 20, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, flying_dog_head);
            ...
            func_802C78B0_6D8F60(1, 0x13, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, flying_dog_neck_detail);
            D_80203FE0[1].unk4 += spDA;
            func_80356F64_768614(img_flying_dog_wing_TLUT1_pal, img_flying_dog_wing_TLUT2_pal, img_flying_dog_wing_ci4__png);
            func_802C78B0_6D8F60(0, 0x17, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, flying_dog_wing);
            func_802C78B0_6D8F60(0, 0x19, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, flying_dog_wing);

            if (D_803D552C->unk312 == 2) {
                gDPSetPrimColor(gOpaqueDL++, 0, 0, 0xFF, (SSSV_RAND(0x80) + 0x80), 0x00, 0xFF);
                if (D_803D552C->missileSide != 0) {
                    gSPDisplayList(gOpaqueDL++, flying_dog_muzzle_left);
                } else {
                    gSPDisplayList(gOpaqueDL++, flying_dog_muzzle_right);
                }
            }
            ...
            if (D_803D552C->unk30E != 0) {
                gDPSetPrimColor(gOpaqueDL++, 0, 0, 0xFF, SSSV_RAND(0x80) + 0x80, 0x00, 0xFF);
                if (D_803D552C->missileSide != 0) {
                    gSPDisplayList(gOpaqueDL++, flying_dog_fire_left);
                } else {
                    gSPDisplayList(gOpaqueDL++, flying_dog_fire_right);
                }
                ...
                if (func_80322D68_734418(xPos, zPos, yPos, xPos2, zPos2, yPos, &spCE, &spCC, &spCA, 0x32, 1, 1, 0xE) == 2) {
                    ...
                    if (D_803D5538 == 0) {
                        if ((ABS(gAnimalState.animals[gCurrentAnimalIndex].animal->position.xPos.h - spCE) < 0x60) &&
                            (ABS(gAnimalState.animals[gCurrentAnimalIndex].animal->position.zPos.h - spCC) < 0x60) &&
                            (ABS(gAnimalState.animals[gCurrentAnimalIndex].animal->position.yPos.h - spCA) < 0x60)) {
            ...
            if (gLodDetailState == 0) {
                ...
                func_802C78B0_6D8F60(0x13, 0x14, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_left_eye);
                func_80356BD8_768288(img_eyes_TLUT4_pal, (u8 (*)[128])img_eyes_ci4__png, spDC);
                func_802C78B0_6D8F60(0x13, 0x14, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_right_eye);
            }
    ...
    if ((spD8 == VISIBILITY_VISIBLE) || (spD8 == VISIBILITY_OUT_OF_BOUNDS_X)) {
        ...
        func_8034BD20_75D3D0(D_803D552C->position.xPos.h, D_803D552C->position.zPos.h, D_803D552C->position.yPos.h + (D_803D5524->height >> 1), D_803D552C->heading, img, 37 - ((ABS(D_803D5530->unk28) * 0x25) / 100), 0x25, 0x9B, 0, 0, 0, 0, D_803D5538);
    }
    if (spD8 == VISIBILITY_VISIBLE) {
        func_803034D0_714B80(D_803D552C, 600, 0, 1);
        func_80303990_715040(D_803D552C, 0x20, 0x21, 0x13, 0x14, 0x1BB, 0);
...
void func_802ED108_6FE7B8(void) {
    ...
    if ((D_803D5538 != 0) && (CHECK_SEGMENT != 0)) {
        ...
        spB2 = classify_object_visibility(
            D_803D552C->position.xPos.w,
            D_803D552C->position.zPos.w,
            D_803D552C->position.yPos.w + (D_803D5524->height << 0xF),
            0x800,
    ...
    if (spB2 == 0) {
        ...
        if ((gAnimalBehaviourEnabled != 0) && (gUiFlowState.unk0 == 0) && (D_803D5530->unk4A == 0) && (temp_t6 != 0) && ((D_803D552C->movementMode == MOVEMENT_MODE_NORMAL) || (D_803D552C->movementMode == MOVEMENT_MODE_INJURED))) {
            ...
            if (D_803D552C->unk30A == 0) {
                if ((((temp_t6 & 0xFF) == 0xFA) || ((temp_t6 & 0xFF) == 0x8C) || ((temp_t6 & 0xFF) == 0xA0) || ((temp_t6 & 0xFF) == 0xAA) || ((temp_t6 & 0xFF) == 0xB4) || ((temp_t6 & 0xFF) == 0xC8) || (((temp_t6 & 0xFF) == 0xDC) && (((D_803D552C->movementMode == MOVEMENT_MODE_NORMAL)) || (D_803D552C->movementMode == MOVEMENT_MODE_INJURED)))) && ((D_803D5538 == 0) || (((gCameras[gCameraId].cameraMode != 3)) && (gCameras[gCameraId].cameraMode != 0x11) && (gCameras[gCameraId].cameraMode != 5) && (gCameras[gCameraId].cameraMode != 6) && (gCameras[gCameraId].cameraMode != 7) && (gCameras[gCameraId].cameraMode != 0x1C) && (gCameras[gCameraId].cameraMode != 0x1A)))) {
        ...
        if (((gDisplayListContext->usedModelViewMtxs +  30) < 250) &&
            (D_803F2EDA != 0) &&
            ((D_803D5538 != 0) || (((tmp = gCameraUiState) == 0)) || (tmp == 2) || ((tmp == 1) && (D_803F2AA3 >= 0xB))) &&
            ...
            func_8038C230_79D8E0((D_803D5524->height * 8 / 5), 2, 3, 3, 0.22f);
            load_1_tile(img_dog_body_pal, img_dog_body_ci4__png);
            func_802C78B0_6D8F60(2, 1, (D_803F2EBC << 6) >> 6, (D_803F2EC0 << 6) >> 6, (D_803F2EC4 << 6) >> 6, D_803F2ED0, spAC, 0, 0, dog_body);
            func_802C78B0_6D8F60(19, 20, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_head);
            if ((D_803D5540 >= 0xB5) && ((D_803D552C->movementMode == MOVEMENT_MODE_INJURED) || (D_803D552C->movementMode == MOVEMENT_MODE_NORMAL))) {
            ...
            gDPSetPrimColor(gOpaqueDL++, 0, 0, 0x14, 0x14, 0x14, 0xFF);
#pragma _permuter sameline start
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(1, 19, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_neck); }
#pragma _permuter sameline end
            gSPDisplayList(gOpaqueDL++, D_01003548_3CE18);

            if (gLodDetailState == 0) { func_802C78B0_6D8F60(3, 7,  FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_upper_leg); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(4, 10, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_upper_leg); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(5, 13, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_upper_leg); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(6, 16, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_upper_leg); }
            func_802C78B0_6D8F60(7,  8,  FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_lower_leg);
            func_802C78B0_6D8F60(10, 11, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_lower_leg);
            func_802C78B0_6D8F60(13, 14, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_lower_leg);
            func_802C78B0_6D8F60(16, 17, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_lower_leg);
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(8,  9,  FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_foot); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(11, 12, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_foot); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(14, 15, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), D_803F2ED0, 0, 0, 0, dog_foot); }
...
#pragma _permuter sameline end
                func_80356BD8_768288(img_eyes_TLUT2_pal, (u8 (*)[128])img_eyes_ci4__png, spB6);
                func_802C78B0_6D8F60(19, 20, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_left_eye);
                func_80356BD8_768288(img_eyes_TLUT2_pal, (u8 (*)[128])img_eyes_ci4__png, spB4);
                func_802C78B0_6D8F60(19, 20, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, (D_803F2EC8 << 6) >> 6, D_803F2ED0, 0, 0, 0, dog_right_eye);
            }
            gSPPopMatrix(gOpaqueDL++, G_MTX_MODELVIEW);
        }
        func_8035D6A0_76ED50();
    ...
    if ((spB2 == 0) || (spB2 == 2)) {
        func_8034BD20_75D3D0(D_803D552C->position.xPos.h, D_803D552C->position.zPos.h, D_803D552C->position.yPos.h + (D_803D5524->height >> 1), D_803D552C->heading, img_D_01033190_6CA60_i4__png, 0x15, 0x12, 0x9B, 0, 0, 0, 0, D_803D5538);
    }
    if (spB2 == 0) {
