...
// RACING_DOG
#ifdef NON_MATCHING
// CURRENT (179) - stack and regalloc
void func_802EA7F0_6FBEA0(void) {
    ...
    sp92 = func_802E89F0_6FA0A0(D_803D552C->xPos.w, D_803D552C->zPos.w, D_803D552C->yPos.w + (D_803D5524->unkBA << 0xF), 0x800, 0, 0x9E, 0x9E, 0x4F, 1, var_v0 == 0);
