...
void func_80376D40_7883F0(void) {
    ...
    if ((D_803D5538 != 0) && (CHECK_SEGMENT != 0)) {
        ...
        sp11A = classify_object_visibility(D_803D552C->position.xPos.w, D_803D552C->position.zPos.w, D_803D552C->position.yPos.w + (D_803D5524->height << 0xF), 0x780, 5, 0x99, 0, 0, 1, CHECK_SEGMENT == 0);
    }
    ...
    if (sp11A == 0) {
        ...
        case ATTACK_SCORPION_1:
            ...
            if (tailIndex != 0) {
                if ((gGameplayTick - D_803D552C->unk32A) < 8) {
                    D_803E00C0[tailIndex].tailType = TAIL_TYPE_SCORPION_RAISED;
                } else {
                    D_803E00C0[tailIndex].tailType = TAIL_TYPE_SCORPION;
                }
            }
            break;
                ...
                if (ticks_remaining < 22) {
                    ...
                    if (ticks_remaining >= 18) {
                        ...
                        if (ticks_remaining == 19) {
                            ...
                            if (D_803D552C->attackTarget->unk16C->animalType == DESERT_FOX_ATTACKING) {
                                func_802B356C_6C4C1C(D_803D552C->attackTarget, D_803D552C->unk30A / 3, D_803D5524->scoreTier, 0);
                            } else {
                                func_802B356C_6C4C1C(D_803D552C->attackTarget, D_803D552C->unk30A, D_803D5524->scoreTier, 0);
                            }
                            if (D_803D5538 != 0) {
                    ...
                    if ((gScorpionVtxIdx + 12) < 37) {
                        gSPDisplayList(gOpaqueDL++, D_01003780_3D050);
                        ...
                        if ((sp108 - var_s3) >= 3) {
                            ...
                            switch (sp108 - var_s3) {
                            case 3:
                                gSPVertex(gOpaqueDL++, spF4, 4, 0);
                                gSPDisplayList(gOpaqueDL++, D_04006610_EDBC0);
                                gScorpionVtxIdx += 4;
                                break;
                            case 4:
                                gSPVertex(gOpaqueDL++, spF4, 6, 0);
                                gSPDisplayList(gOpaqueDL++, D_04006620_EDBD0);
                                gScorpionVtxIdx += 6;
                                break;
                            case 5:
                                gSPVertex(gOpaqueDL++, spF4, 8, 0);
                                gSPDisplayList(gOpaqueDL++, D_04006638_EDBE8);
                                gScorpionVtxIdx += 8;
                                break;
                            case 6:
                                gSPVertex(gOpaqueDL++, spF4, 10, 0);
                                gSPDisplayList(gOpaqueDL++, D_04006658_EDC08);
                                gScorpionVtxIdx += 10;
                                break;
                            }
                        }
        ...
        if (((gDisplayListContext->usedModelViewMtxs + 30) < 250) && (D_803F2EDA != 0) && ((D_803D5538 != 0) || (temp_v0 = gCameraUiState, (temp_v0 == 0)) || (temp_v0 == 2) || ((temp_v0 == 1) && (D_803F2AA3 >= 0xB))) && ((D_803F2C18[0] != 0) || (D_803D5538 == 0) || (((gCameras[gCameraId].cameraMode != 3)) && (gCameras[gCameraId].cameraMode != 0x11)) || (gCameras[gCameraId].zoomIndex != -3))) {
            ...
            func_8038C230_79D8E0((D_803D5524->height << 3) / 5, 2, 3, 3, -0.1f);
            add_hilite();
            gSPDisplayList(gOpaqueDL++, D_01003588_3CE58);
            gDPSetPrimColor(gOpaqueDL++, 0, 0, 0xFF, 0x00, 0x00, 0xFF); // RED
            ...
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(22, 23, (D_803F2EC8 * 0x28) >> 6, (D_803F2EC8 * 0x28) >> 6, (D_803F2EC8 * 0x28) >> 6, D_803F2ED0, 0, 0, 0, D_04005950_ECF00); }
            func_802C78B0_6D8F60(3, 7, FTOFIX32(0.625), FTOFIX32(0.625), FTOFIX32(0.625), D_803F2ED0, 0, 0, 1, D_04005C80_ED230);
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(8, 9, FTOFIX32(0.625), FTOFIX32(0.625), FTOFIX32(0.625), D_803F2ED0, 0, 0, 1, D_04005C80_ED230); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(14, 15, FTOFIX32(0.625), FTOFIX32(0.625), FTOFIX32(0.625), D_803F2ED0, 0, 0, 1, D_04005C80_ED230); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(5, 13, FTOFIX32(0.625), FTOFIX32(0.625), FTOFIX32(0.625), D_803F2ED0, 0, 0, 1, D_04005C80_ED230); }

            gSPClearGeometryMode(gOpaqueDL++, G_CULL_BACK);
            gSPSetGeometryMode(gOpaqueDL++, G_CULL_FRONT);

            if (gLodDetailState == 0) { func_802C78B0_6D8F60(24, 25, (D_803F2EC8 * 0x28) >> 6, (D_803F2EC8 * 0x28) >> 6, (D_803F2EC8 * 0x28) >> 6, D_803F2ED0, (s16) 0, (u8) 1, (u8) 0, D_04005950_ECF00); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(4,  10, FTOFIX32(0.625), FTOFIX32(0.625), FTOFIX32(0.625), D_803F2ED0, 0, 2, 1, D_04005C80_ED230); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(11, 12, FTOFIX32(0.625), FTOFIX32(0.625), FTOFIX32(0.625), D_803F2ED0, 0, 2, 1, D_04005C80_ED230); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(17, 18, FTOFIX32(0.625), FTOFIX32(0.625), FTOFIX32(0.625), D_803F2ED0, 0, 2, 1, D_04005C80_ED230); }
            ...
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(22, 23, (D_803F2EC8 * 0x28) >> 6, (D_803F2EC8 * 0x28) >> 6, (D_803F2EC8 * 0x28) >> 6, D_803F2ED0, 0, 0, 0, D_04005D70_ED320); }
    ...
    if ((sp11A == 0) || (sp11A == 2)) {
        func_8034BD20_75D3D0(D_803D552C->position.xPos.h, D_803D552C->position.zPos.h, (D_803D552C->position.yPos.h + (D_803D5524->height >> 1)), D_803D552C->heading, img_D_01033190_6CA60_i4__png, 0x12, 0xF, 0x9B, 0, 0, 0, 0, D_803D5538);
    }
...
void func_80378B84_78A234(s16 i, s16 *arg1, s16 *x, s16 *y, s16 *z, Animal *target) {
    ...
    sp32 = D_803D552C->position.yPos.h + D_803D5524->height;
...
void func_80379070_78A720(void) {
    if (D_803D552C->unk365 == ATTACK_NONE) {
        Animal *target = func_8037ED1C_7903CC();
        if (target == NULL) {
            recharge_skill(SKILL_B);
        } else {
            // perform lightning attack
            D_803D552C->attackTarget = target;
...
void func_80379148_78A7F8(Animal *target) {
    if ((D_803D552C->unk365 == ATTACK_NONE) && (target != NULL)) {
        D_803D552C->attackTarget = target;
        D_803D552C->unk365 = ATTACK_SCORPION_2;
        D_803D552C->unk32A = gGameplayTick;
        D_803D552C->unk30C = D_803D552C->attackTarget->position.yPos.h + (D_803D552C->attackTarget->unk42 >> 1);
