...
u8 D_803B5860_7C6F10[] = {
    0x00, 0x01, 0x02, 0x00,
};
u8 D_803B5864_7C6F14[] = {
    0x01, 0x02, 0x03, 0x00,
};
s16 D_803B5868_7C6F18[] = {
    0x000A, 0x03E8, 0x01F4,
    0x0000,
};
s16 D_803B5870_7C6F20[] = {
    0x0000, 0x0168, 0x0136,
    0x005A, 0x00FE, 0x005A,
    0x00B0, 0x004E, 0x0070,
    0x0000,
};
s16 D_803B5884_7C6F34[] = {
    0x0000, 0x0280, 0x051E,
    0x0082, 0x00B4, 0x005A,
    0x00B4, 0x0030, 0x00B4,
...
void func_80382050_793700(void) {
    ...
    if (sp7A == 0) {
        ...
        sp76 = ((SIN(D_803D5540 << 4) >> 7) + 256) >> 6;
        if (D_803D552C->unk365 == ATTACK_BITE) {
            sp76 = ((SIN(D_803D5540 << 5) >> 7) + 256) >> 3;
            if ((D_803D5540 & 7) == 0) {
