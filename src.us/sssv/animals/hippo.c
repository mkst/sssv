...
extern Gfx D_0400B470_FC4D0[];
extern Gfx D_0400B4C0_FC520[];
...
void update_hippo(void) {
    ...
    if ((D_803D5538 != 0) && (CHECK_SEGMENT != 0)) {
        gLodDetailState = spFA = 0;
    } else {
        spFA = classify_object_visibility_6FA0A0(D_803D552C->position.xPos.w, D_803D552C->position.zPos.w, D_803D552C->position.yPos.w + (D_803D5524->unkBA << 0xF), 0x15E0, 5, 0x99, 0x46, 0x46, 1, CHECK_SEGMENT == 0);
    }
    ...
    if (spFA == 0) {
        ...
        if (D_803D552C->unk365 == ATTACK_SPIT) {
            ...
            if (spF6 >= 0xA) {
                ...
                gDPSetPrimColor(gOpaqueDL++, 0, 0, 0xB4, 0xFF, 0xB4, 0xFF);

                func_80127640(&gDisplayListContext->modelViewMtx[gDisplayListContext->usedModelViewMtxs], D_803D5530->position.xPos.w, D_803D5530->position.zPos.w, D_803D5530->position.yPos.w, -D_803D552C->unk32C, FTOFIX32(1.0), FTOFIX32(1.0), FTOFIX32(1.0), 0, 0);
                ...
                switch (spF6) {
                case 10:
                    gSPDisplayList(gOpaqueDL++, D_0400B420_FC480);
                    break;
                case 11:
                    gSPDisplayList(gOpaqueDL++, D_0400B470_FC4D0);
                    break;
                case 12:
                    gSPDisplayList(gOpaqueDL++, D_0400B4C0_FC520);
                    break;
                case 13:
                    gSPDisplayList(gOpaqueDL++, D_0400B510_FC570);
                    break;
                case 14:
                    gSPDisplayList(gOpaqueDL++, D_0400B560_FC5C0);
                    break;
                case 15:
                    gSPDisplayList(gOpaqueDL++, D_0400B5B0_FC610);
                    break;
                }
        ...
        if (((gDisplayListContext->usedModelViewMtxs + 30) < 250) &&
            (D_803F2EDA != 0) &&
            (((D_803D5538 != 0)) || (((var_v0 = gCameraUiState) == 0)) || (var_v0 == 2) || ((var_v0 == 1) && (D_803F2AA3 >= 0xB))) &&
            ...
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(5, 0xD, FTOFIX32(1.5625), FTOFIX32(1.5625), FTOFIX32(1.5625), D_803F2ED0, 0, 0, 0, D_0400A840_FB8A0); }
            ...
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(4, 0xA, FTOFIX32(1.5625), FTOFIX32(1.5625), FTOFIX32(1.5625), D_803F2ED0, 0, 1, 0, D_0400A840_FB8A0); }
            if (gLodDetailState == 0) { func_802C78B0_6D8F60(6, 0x10, FTOFIX32(1.5625), FTOFIX32(1.5625), FTOFIX32(1.5625), D_803F2ED0, 0, 1, 0, D_0400A840_FB8A0); }
            gSPDisplayList(gOpaqueDL++, D_010034C0_3CD90);
    ...
    if ((spFA == 0) || (spFA == 2)) {
        func_8034BD20_75D3D0(D_803D552C->position.xPos.h, D_803D552C->position.zPos.h, (D_803D552C->position.yPos.h + (D_803D5524->unkBA >> 1)), D_803D552C->heading, img_D_01033190_6CA60_i4__png, 0x3E, 0x2E, 0x9B, 0, 0, 0, 0, D_803D5538);
    }
    if (spFA == 0) {
