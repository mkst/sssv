...
void func_80301248_7128F8(void) {
    ...
    if ((sp84 != 4) && (sp84 != 1) && ((D_803D552C->unk366 == 3) || (D_803D552C->unk366 == 1) || (D_803D552C->unk366 == 4))) {
        ...
        if (temp_f16 < 0.6) { // 0.6 (D_803BCFA8_7CE658)
            temp_f14 = (temp_f16 * 1.666); // 1.666 (D_803BCFB0_7CE660)
        } else {
            temp_f14 = 1.0f;
        }
        if (temp_f14 > 0.0) {
            ...
            func_8013328C(D_803D5530 + 2, SFX_UNKNOWN_28, 64, 1.2 * temp_f16, ((temp_f14 * temp_f16) / 3.0), 0);
        }
    }
    if (sp84 == 0) {
        ...
        if (((D_80204278->usedModelViewMtxs + 30) < 250) &&
            ...
            if (D_803F2EDD == 0) {
                ...
                sp88 = D_803BD564_7CEC14[sp88]; sp86 = D_803C29E4_7D4094[sp86];
