...
void func_8035D120_76E7D0(void) {
    ...
    if ((D_803D5540 & 2) && (D_803D552C->lastHpLost > 0)) {
        Animal *a = D_803D552C;
        D_803F2EDC = 1;
        if (a->lastHpLost < 3) {
...
void func_8035D6D0_76ED80(void) {
    ...
    if ((D_803D552C->lastHpLost - 1) < 0) {
        D_803D552C->lastHpLost = 0;
    } else {
        D_803D552C->lastHpLost -= 1;
    }
}
...
void func_8035D734_76EDE4(void) {
    ...
    if ((D_803D552C->movementMode == MOVEMENT_MODE_CRITICAL) || ((D_803D5538 != 0) && (D_803D5530->Info.health < 15))) {
