...
//             // temp_s1_3->unk4 = (s32) (D_803D3440->unk3 | (D_803D3440->unk0 << 0x18) | (D_803D3440->unk1 << 0x10) | (D_803D3440->unk2 << 8));
...
//             }
//
//             gDPSetTextureImage(D_801D9E8C++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, (s32)D_0102F010 + 2048 * current_texture);
