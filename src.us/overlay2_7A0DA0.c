...
void load_pause_menu(s32 arg0, s16 arg1) {
    ...
    func_803962EC_7A799C(&gMainDL,
        ...
        D_803F670A, // x1
        D_803F670C, // y1
        D_800BA760 + 0xb2e0, // current framebuffer?
...
#define BOOST_BLUE 0
    ...
    if (arg9 == 1) {
        ...
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 0 * 2048, 32, 32, 1.0f, 1.0f, 0, 0, arg0, arg1 + 1);
        ...
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 2 * 2048, 32, 32, 1.0f, 1.0f, 0, 0, arg0, arg1 + 32);
        ...
        // 2x legs
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 1 * 2048, 32, 32, 1.0f, 1.0f, 0, 0, arg0 + 12, arg1 + 58);
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 1 * 2048, 32, 32, 1.0f, 1.0f, 1, 0, arg0 - 12, arg1 + 58);
        ...
        // 2x arms
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 3 * 2048, 32, 32, 1.0f, 1.0f, 0, 0, arg0 + 26, arg1 + 28);
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 3 * 2048, 32, 32, 1.0f, 1.0f, 1, 0, arg0 - 26, arg1 + 28);
    } else {
        scale = 0.5f;
        if (head) {
            gDPSetPrimColor(gMainDL++, 0, 0, red + BOOST_RED, green + BOOST_GREEN, blue+ BOOST_BLUE, 0xFF);
        ...
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 0 * 2048, 32, 32, scale, scale, 0, 0, arg0, arg1);
        ...
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 2 * 2048, 32, 32, scale, scale, 0, 0, arg0, arg1 + (32 * scale));
        ...
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 1 * 2048, 32, 32, scale, scale, 0, 0, arg0 + (12 * scale), arg1 + (58 * scale));
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 1 * 2048, 32, 32, scale, scale, 1, 0, arg0 - (12 * scale), arg1 + (58 * scale));
        ...
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 3 * 2048, 32, 32, scale, scale, 0, 0, arg0 + (26 * scale), arg1 + (28 * scale));
        func_8039C834_7ADEE4(&gMainDL, TEXTURE_EVO_THUMBNAIL + 3 * 2048, 32, 32, scale, scale, 1, 0, arg0 - (26 * scale), arg1 + (28 * scale));
    }
}
