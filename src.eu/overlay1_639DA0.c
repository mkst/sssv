...
extern Subtitle D_8029AE60_63FD90[]; // ?
...
void func_80296590_63B4C0(struct018 *arg0) {
    ...
    case 2:
        ...
        if (D_8029B4F0_640420 != 0xFF) {
            ...
            if (D_8029AE60_63FD90[D_8029B4F0_640420].msg[D_8029B318_640248].startTime == D_8029B308_640238) {
                D_8029B32C_64025C = D_8029AE60_63FD90[D_8029B4F0_640420].msg[D_8029B318_640248].sfx;
                D_8029B334_640264 = 0;
                D_8029B33C_64026C = 0;
                D_8029B340_640270 = 1;
                ...
                if (D_8029AE60_63FD90[D_8029B4F0_640420].msg[D_8029B318_640248].sfx != 0xFF) {
                    if (D_8029AE60_63FD90[D_8029B4F0_640420].msg[D_8029B318_640248].sfx == 0x57) {
                        spC0 = 0x2500;
                    } else {
                        spC0 = 0x5500;
                    }
                    if (D_8029B520_640450 == 0) {
                        if (D_802042B4 == 0x3C) {
                            func_8013309C(D_8029AE60_63FD90[D_8029B4F0_640420].msg[D_8029B318_640248].sfx, 0, spC0, 1.2f, 0);
                        } else {
                            func_8013309C(D_8029AE60_63FD90[D_8029B4F0_640420].msg[D_8029B318_640248].sfx, 0, spC0, 1.0f, 0);
                        }
                    }
                }
                D_8029B318_640248 = D_8029B318_640248 + 1;
            } else {
                if ((D_8029AE60_63FD90[D_8029B4F0_640420].msg[D_8029B318_640248].startTime == 0) && (D_8029B4F0_640420 < 0x1C)) {
                    D_8029B318_640248 = 0;
                    D_8029B308_640238 = 0;
                    D_8029B4F0_640420++;
                }
        ...
        if (D_8029B4F0_640420 != 0xFF) {
            if (D_8029AE60_63FD90[D_8029B4F0_640420].id != 0xD) {
                func_8012C210(&D_801D9E9C);
                func_8012C234(0xFFU, 0xFFU, 0xFF, 0xFF);
                func_8012C268(0, 1, 1, 0);
                func_8012EB6C(&D_801D9E9C, get_message_address_by_id(D_8029AE60_63FD90[D_8029B4F0_640420].id), 0xA0, 0xCA, 16.0f, 16.0f, 0x10);
            }
