...
// thread6
#pragma GLOBAL_ASM("asm/nonmatchings/thread6/func_80129B10.s")
...
void func_80129DC0(void) {
    ...
    while (TRUE) {
        ...
        case 1:
            ...
            if ((D_80152EDC < 2) && (phi_s1 == 0) && (D_802042B2 >= gDebugTextBuffer)) {
                func_80136F84();
                if (D_802912F8 != 0) {
                    func_80137114();
            ...
            break;
        case 2:
            if (gDebugTextBuffer == 1) {
                func_8012ABB4();
            } else if (D_802042B2 >= (gDebugTextBuffer - 1)) {
                func_8012ABB4();
            }
            D_80152EC4 = 0;
            D_802042C8 = 0;
...
// thread7
#pragma GLOBAL_ASM("asm/nonmatchings/thread6/func_8012A280.s")

#pragma GLOBAL_ASM("asm/nonmatchings/thread6/func_8012A420.s")

#pragma GLOBAL_ASM("asm/nonmatchings/thread6/end_display_lists.s")

#pragma GLOBAL_ASM("asm/nonmatchings/thread6/func_8012A5A8.s")

#pragma GLOBAL_ASM("asm/nonmatchings/thread6/func_8012A770.s")
